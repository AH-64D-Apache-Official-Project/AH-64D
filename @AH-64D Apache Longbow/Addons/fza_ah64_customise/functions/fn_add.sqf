...
if (_targetComp == "IAFS") exitwith {
    [
        ...
        [_target, _player],
        {
            ...
            [_target, 0] remoteExec ["fza_weapons_fnc_SwapM230Mag", [gunner _target, driver _target]];
            //Spawn 1200rnd Mag
...
if (_targetComp == "MAG") exitwith {
    [
        ...
        [_target, _player],
        {
            ...
            [_target, 1] remoteExec ["fza_weapons_fnc_SwapM230Mag", [gunner _target, driver _target]];
            //spawn IAFS
