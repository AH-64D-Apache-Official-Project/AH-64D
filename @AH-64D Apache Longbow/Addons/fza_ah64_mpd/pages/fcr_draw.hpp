class fcr_draw {
    ...
    class text {
        ...
        MPD_TEXT_R(SSS, 0.22 - (6*MPD_TEXT_WIDTH), 0.939 - MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("TADS/L"))
        //Range and Range Source 5 chars
        MPD_TEXT_L(RRS, 0.22 + (6*MPD_TEXT_WIDTH),     0.939 - MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("*9999"))
        //Sight Status (12 chars)
        MPD_TEXT_R(SS,  0.22 - (6*MPD_TEXT_WIDTH), 0.939, MPD_TEXT_STATIC("XXXXXXXXXXXX"))

        //HAD right
        //Weapon Control 5 chars
        MPD_TEXT_R(WC,  0.78 - (6*MPD_TEXT_WIDTH), 0.939 - MPD_TEXT_HEIGHT, MPD_TEXT_STATIC("CMSL"))
