...
MPD_TEXT_C(PAGE_NUMA, ((MPD_POS_BUTTON_TB_2_X + MPD_POS_BUTTON_TB_3_X)/2), MPD_POS_BUTTON_B_Y, MPD_TEXT_STATIC(" /3"))
MPD_TEXT_C(PAGE_NUMB, ((MPD_POS_BUTTON_TB_2_X + MPD_POS_BUTTON_TB_3_X)/2) - MPD_TEXT_WIDTH, MPD_POS_BUTTON_B_Y, MPD_TEXT_USER(MFD_IND_ABR_PAGENUM))
