    ...
    class vabs {
        ///////////////// T ///////////////
        MPD_ARROW_C(FLT, MPD_POS_BUTTON_TB_1_X, MPD_POS_BUTTON_T_Y, 3)
        MPD_TEXT_C(FLT,  MPD_POS_BUTTON_TB_1_X, MPD_POS_BUTTON_T_Y, MPD_TEXT_STATIC("FLT"))

        MPD_ARROW_C(FUEL, MPD_POS_BUTTON_TB_2_X, MPD_POS_BUTTON_T_Y, 4)
        MPD_TEXT_C(FUEL,  MPD_POS_BUTTON_TB_2_X, MPD_POS_BUTTON_T_Y, MPD_TEXT_STATIC("FUEL"))

        MPD_ARROW_C(PERF, MPD_POS_BUTTON_TB_3_X, MPD_POS_BUTTON_T_Y, 4)
        MPD_BOX_C(PERF,   MPD_POS_BUTTON_TB_3_X, MPD_POS_BUTTON_T_Y, 4)
        MPD_TEXT_C(PERF,  MPD_POS_BUTTON_TB_3_X, MPD_POS_BUTTON_T_Y, MPD_TEXT_STATIC("PERF"))
