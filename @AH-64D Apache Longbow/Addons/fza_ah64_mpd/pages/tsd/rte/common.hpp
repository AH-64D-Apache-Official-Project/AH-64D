...
class rteCommon {
    ...
    class vabs {
        ...
        class routePoints {
            //R2
            MPD_TEXT_L(WP_INDEX_04, MPD_POS_BUTTON_R_X - MPD_TEXT_WIDTH, MPD_POS_BUTTON_LR_2_Y, MPD_TEXT_USER(MFD_TEXT_IND_TSD_RTE_POINT_R2))
            //R3
            MPD_TEXT_L(WP_INDEX_03, MPD_POS_BUTTON_R_X - MPD_TEXT_WIDTH, MPD_POS_BUTTON_LR_3_Y, MPD_TEXT_USER(MFD_TEXT_IND_TSD_RTE_POINT_R3))
            //R4
            MPD_TEXT_L(WP_INDEX_02, MPD_POS_BUTTON_R_X - MPD_TEXT_WIDTH, MPD_POS_BUTTON_LR_4_Y, MPD_TEXT_USER(MFD_TEXT_IND_TSD_RTE_POINT_R4))
            //R5
            MPD_TEXT_L(WP_INDEX_01, MPD_POS_BUTTON_R_X - MPD_TEXT_WIDTH, MPD_POS_BUTTON_LR_5_Y, MPD_TEXT_USER(MFD_TEXT_IND_TSD_RTE_POINT_R5))
        };
        //B5
    ...
    class routeEnd {
        ...
        class index4 {
            ...
            MPD_BOX_BAR_L(END_BAR_04, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_2_Y)
        };
    };
    class routeSelected {
        class index1 {
    ...
    class routeEditable {
        condition = C_COND(C_EQ(C_MPD_USER(MFD_IND_TSD_RTE_POINTEDIT), 1));
        class index1 {
            condition = C_COND(C_MORE(C_MPD_USER(MFD_IND_TSD_RTE_END_INDEX), 0));
            MPD_BOX_BAR_L(PointNoEdit, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_5_Y)
        };
        class index2 {
            condition = C_COND(C_MORE(C_MPD_USER(MFD_IND_TSD_RTE_END_INDEX), 1));
            MPD_BOX_BAR_L(PointNoEdit, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_4_Y)
        };
        class index3 {
            condition = C_COND(C_MORE(C_MPD_USER(MFD_IND_TSD_RTE_END_INDEX), 2));
            MPD_BOX_BAR_L(PointNoEdit, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_3_Y)
        };
        class index4 {
            condition = C_COND(C_MORE(C_MPD_USER(MFD_IND_TSD_RTE_END_INDEX), 3));
