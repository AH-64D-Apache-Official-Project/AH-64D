class StatusWindows {
    ...
    MPD_TEXT_C(ACQ, 0.685, 0.12+MPD_TEXT_HEIGHT, MPD_TEXT_USER(MFD_TEXT_IND_WPN_ACQ_SRC))

    MPD_TEXT_C(LST_Label, 0.305, 0.24, MPD_TEXT_STATIC("LST"))
    MPD_TEXT_C(LST, 0.305, 0.24+MPD_TEXT_HEIGHT, MPD_TEXT_USER(MFD_TEXT_IND_WPN_LST_CODE))
