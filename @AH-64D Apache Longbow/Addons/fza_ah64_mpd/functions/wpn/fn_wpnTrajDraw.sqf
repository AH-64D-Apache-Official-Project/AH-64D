...
[_heli, MFD_INDEX_OFFSET(MFD_IND_WPN_POPOUT_MENU), _popOutMenu] call fza_mpd_fnc_updateMfdValue;
[_heli, MFD_INDEX_OFFSET(MFD_IND_WPN_POPOUT), _traj] call fza_mpd_fnc_updateMfdValue;