...
if (isNil "_pointDetails") then {
    ...
    private _wptDetails_1 = format["%1 %2 %3 ETE %4 ETA %5L", _currentPointStr, _pointDetails select POINT_GET_IDENT, [_pointDetails select POINT_GET_FREE_TEXT,3]  call fza_util_fnc_padString, _timeToWpt, _arriveAtWpt];
    //Line 2
    ...
    private _wptDetails_3 = format["%1  %2 FT %3 NM", _wptLatLong, [[_pointDetails select POINT_GET_ALT_MSL,0,0] call CBA_fnc_formatNumber,4] call fza_util_fnc_padString, [_dstToWpt_nm,2,1] call CBA_fnc_formatNumber];
