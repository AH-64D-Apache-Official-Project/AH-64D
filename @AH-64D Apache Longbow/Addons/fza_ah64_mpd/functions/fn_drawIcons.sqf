...
Parameters:
    ...
    _scale - (optional) Ratio to apply to scale from the world's size to the MPD size. Defaults to *fza_ah64_scaleRange x 0.75*
...
if (_scale == -1) then {
    _scale = (0.125 * 5 / (_heli getVariable "fza_ah64_scaleRange"));
};
