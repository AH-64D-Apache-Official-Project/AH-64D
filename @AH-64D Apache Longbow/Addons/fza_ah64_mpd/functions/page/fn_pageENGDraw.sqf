...
private _priHydPSI_text  = format["%1", [str _priHydPSI, 4] call fza_util_fnc_padString];
private _utilHydPSI      = round(_heli getVariable "fza_systems_utilHydPsi");
private _utilHydPSI_text = format["%1", [str _utilHydPSI, 4] call fza_util_fnc_padString];
private _accHydPSI       = round((_heli getVariable "fza_systems_accHydPsi") / 10) * 10;
private _accHydPSI_text  = format["%1", [str _accHydPSI, 4] call fza_util_fnc_padString];
