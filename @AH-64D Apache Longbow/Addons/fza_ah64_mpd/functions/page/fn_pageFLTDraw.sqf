...
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_TORQUE), ( _torque * 100) toFixed 0] call fza_mpd_fnc_updateMfdText;
...
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_BALT),  _barAlt toFixed 0] call fza_mpd_fnc_updateMfdText;
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_GALT), [_radAlt toFixed 0, ""] select (_radAlt == 1420)] call fza_mpd_fnc_updateMfdText;
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_AIRSPEED), _airspeed toFixed 0] call fza_mpd_fnc_updateMfdText;
...
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_DISTANCETOGO), _waypointDist] call fza_mpd_fnc_updateMfdText;

[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_DESTINATION), _waypointId] call fza_mpd_fnc_updateMfdText;
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_TIMETOGO),  _waypointEta] call fza_mpd_fnc_updateMfdText;
[_heli, MFD_INDEX_OFFSET(MFD_TEXT_IND_FLT_GROUNDSPEED), _groundSpeed] call fza_mpd_fnc_updateMfdText;
if (isNil "_nextPointPos") then {
    [_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_COMMAND_HEADING), -360] call fza_mpd_fnc_updateMfdValue;
    [_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FLY_TO_CUE_X), -100] call fza_mpd_fnc_updateMfdValue;
} else {
    private _waypointDirection = [(_heli getRelDir _nextPointPos)] call CBA_fnc_simplifyAngle180;
    [_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_COMMAND_HEADING), _waypointDirection] call fza_mpd_fnc_updateMfdValue;
    ...
    [_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FLY_TO_CUE_X), _flyToCueX] call fza_mpd_fnc_updateMfdValue;
    [_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FLY_TO_CUE_Y), _flyToCueY] call fza_mpd_fnc_updateMfdValue;
};
...
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_ALTERNATE_SENSOR), _alternatesensorpan] call fza_mpd_fnc_updateMfdValue;
...
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FCR_CENTERLINE), _fcrHeading] call fza_mpd_fnc_updateMfdValue;
...
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FLIGHT_PATH_X), _velocityX] call fza_mpd_fnc_updateMfdValue;
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_FLIGHT_PATH_Y), _velocityY] call fza_mpd_fnc_updateMfdValue;
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_VERT_SPEED),    _velocity#2] call fza_mpd_fnc_updateMfdValue;

// Turn and slip indicator
private _bank = (_heli call BIS_fnc_getPitchBank) # 1;
private _bankForStandardTurn = (_airspeed * 1.944) / 10 + 7;
[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_TURN), _bank / _bankForStandardTurn] call fza_mpd_fnc_updateMfdValue;

private _airspeedModelRelative = _heli vectorWorldToModel (_velocity);

private _beta_deg = fza_ah64_sideslip;

[_heli, MFD_INDEX_OFFSET(MFD_IND_FLT_SLIP), _beta_deg] call fza_mpd_fnc_updateMfdValue;
