...
if (fza_ah64_sfmPlusSpringlessCyclic || fza_ah64_sfmPlusControlScheme == MNKB) then {
...
if (fza_ah64_sfmplusSpringlessPedals || fza_ah64_sfmPlusControlScheme == MNKB) then {
