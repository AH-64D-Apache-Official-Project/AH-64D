...
if (!(_heli getVariable ["fza_ah64_aircraftEngineInitialised", false]) && local _heli) then {
    ...
    _heli setVariable ["fza_sfmplus_engState",              [0,0],          true];
    _heli setVariable ["fza_sfmplus_engStartSwitchState",   [0,0],          true];
    _heli setVariable ["fza_sfmplus_engPowerLeverState",    [0,0],          true];
    ...
    _heli setVariable ["fza_sfmplus_engIsOEI",              false,          true];
