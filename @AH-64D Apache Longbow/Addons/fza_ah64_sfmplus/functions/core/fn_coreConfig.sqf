...
//Heading Hold
_heli setVariable ["fza_sfmplus_pid_hdgHold",        [0.075, 0.025, 0.050] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_trnCoord",       [0.500, 0.040, 0.200] call fza_fnc_pidCreate];
