...
_heli setVariable ["fza_sfmplus_pid_pitch",          [0.10, 0.10, 0.10] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_roll",           [0.10, 0.10, 0.10] call fza_fnc_pidCreate];
