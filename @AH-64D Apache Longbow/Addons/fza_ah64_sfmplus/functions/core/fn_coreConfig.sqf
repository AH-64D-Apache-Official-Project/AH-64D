...
_heli setVariable ["fza_sfmplus_pid_pitch",          [0.180, 0.055, 0.250] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_roll",           [0.080, 0.045, 0.250] call fza_fnc_pidCreate];
_heli setVariable ["fza_sfmplus_pid_altHold",        [0.10, 0.05, 0.03] call fza_fnc_pidCreate];
