...
#define POINT_GET_ICON_TEX 2
#define POINT_GET_ICON_COLOR 3
#define POINT_GET_ICON_TYPE 4
#define POINT_GET_ICON_TEXT_A 5
#define POINT_GET_ICON_TEXT_B 6
#define POINT_GET_FREE_TEXT 7
#define POINT_GET_TYPE 8
#define POINT_GET_IDENT 9
#define POINT_GET_GRID_COORD 10
#define POINT_GET_LAT_LONG 11
#define POINT_GET_ALT_MSL 12
#define POINT_GET_ALT_AGL 13
#define POINT_GET_FULL [0,14]
