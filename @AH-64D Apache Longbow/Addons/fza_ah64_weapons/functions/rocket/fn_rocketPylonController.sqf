...
(_heli call fza_weapon_fnc_sightData) params ["_targPos", "_targVel", "_targDistance", "_inhibit"];

systemchat str _targPos;
systemchat str _targVel;
systemchat str _targDistance;
systemchat str _inhibit;
