class fza_275_base: MissileBase {
    ...
    soundsetexplosion[] = {
        ...
        "fza_rocket_explosion_stereo_soundset",
        "fza_shell_explosion_reverb_soundset"
    };
    soundsetsoniccrack[] = {
        "fza_sc_rocket_flyby_soundset"
    };
...
class fza_m73mpsm: GrenadeBase {
    ...
    soundsetexplosion[] = {
        "fza_small_explosion_soundset",
        "fza_he_explosion_stereo_soundset",
        "fza_small_explosion_reverb_soundset"
    };
