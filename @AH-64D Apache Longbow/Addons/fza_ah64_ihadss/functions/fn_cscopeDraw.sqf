...
if (_fcrcount > _ntsIndex && _ntsIndex != -1 && _heli getVariable "fza_ah64_fcrcscope") then {
...
private _guiPos = [-100, -100];
if (_fcrcount > _antsIndex && _antsIndex != -1 && _heli getVariable "fza_ah64_fcrcscope") then {
