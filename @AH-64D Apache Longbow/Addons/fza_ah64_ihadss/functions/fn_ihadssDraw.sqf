...
if !(_heli getvariable "fza_ah64_ihadssinit") then {
    ...
    for "_i" from 121 to 206 do {
        ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl _i) ctrlSetTextColor _hducolor;
    };
...
if (cameraView == "GUNNER" && player == gunner _heli && _powerOnState) then {
    ...
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 130) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ...
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 804) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];

    //HIDE CLICK HELPER FOR HEADSDOWN GUNNER
    ((uiNameSpace getVariable "fza_ah64_click_helper") displayCtrl 601) ctrlSetTextColor[1, 1, 1, 0];

    //COLOR SET THESE
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 121) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 122) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 123) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 124) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 125) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 126) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 127) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 128) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 131) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 132) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 133) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 134) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 137) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl 207) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    ...
    do {
        if (!(_ihadssidx == 135 || _ihadssidx == 136 || _ihadssidx == 182 || _ihadssidx == 186 || _ihadssidx == 123 || _ihadssidx == 124 || _ihadssidx == 125 || _ihadssidx == 120)) then {
            ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl _ihadssidx) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
        };
    ...
    if !(isNull laserTarget _heli) then {
        ...
        ((uiNameSpace getVariable "fza_ah64_laseit") displayCtrl 701) ctrlSetTextColor[(_hducolor select 1), (_hducolor select 1), (_hducolor select 1), 1];
    };
    ...
    do {
        ((uiNameSpace getVariable "fza_ah64_raddisp") displayCtrl _ihadssidx) ctrlSetTextColor _hducolor;
        _ihadssidx = _ihadssidx + 1;
    };
