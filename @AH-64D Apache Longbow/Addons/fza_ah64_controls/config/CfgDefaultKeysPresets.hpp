	...
	class Arma2 {
		class Mappings {
			/*
				...
				DD		= button local ID
			*/	
			fza_ah64_sightSelectHMD[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x02}; //Ctrl+1
			fza_ah64_sightSelectTADS[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x03}; //Ctrl+2
			fza_ah64_sightSelectFXD[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x04}; //Ctrl+3
			fza_ah64_sightSelectFCR[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x05}; //Ctrl+4
			fza_ah64_fcrModeGTM[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x23}; //Ctrl+H
			fza_ah64_fcrModeATM[] = {COMBO_LSHIFT + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x23}; //Shift+H
			fza_ah64_symbologySelectUp[] = {COMBO_LSHIFT + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x30}; //Shift+B
			fza_ah64_symbologySelectDown[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x30}; //Ctrl+B
			...
			fza_ah64_targetStoreUpdate[] = {COMBO_LSHIFT + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x22}; //Shift+G
			fza_ah64_crosshairInteract[] = {INPUT_DEVICE_COMBO_KB + Ox56}; // Backslash (\)
			fza_ah64_waypointIncrease[] = {COMBO_LSHIFT + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x06}; //Shift+5
			fza_ah64_waypointDecrease[] = {COMBO_LCTRL + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x06}; //Ctrl+5
			fza_ah64_laserCycle[] = {COMBO_LALT + INPUT_DEVICE_COMBO_KB + INPUT_DEVICE_MAIN_KB + 0x14}; //Alt+T
		};
	};
};