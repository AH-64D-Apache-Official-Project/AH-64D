class Sounds
{
        ...
        class RainExt
        {
            sound[] = {"\fza_ah64_model\audio\Ext_Rain.ogg", 1.000000, 1.000000, 100};
            frequency = 1;
            volume = "camPos * (rain - rotorSpeed/2) * 2";
        };
        class RainInt
        {
            sound[] = {"\fza_ah64_model\audio\Int_Rain.ogg", 1.000000, 1.000000, 100};
            frequency = 1;
        ...
        {
            sound[]   = {"\fza_ah64_model\audio\CreakingAirFrame.ogg", 1, 1};
