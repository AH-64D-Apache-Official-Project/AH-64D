class CfgVehicles {
    ...
    class fza_ah64base : Helicopter_Base_F {
        ...
        rotorDamageInt[]         = {"\fza_ah64_control\audio\Int_Rotor_Damage.ogg", 1.000000, 1.000000};
        rotorDamageOut[]         = {"\fza_ah64_control\audio\Ext_Rotor_Damage.ogg", 2.511886, 1.000000, 100};
        ...
        soundDammage[]           = {"\fza_ah64_control\audio\Crash.ogg", 3.162278, 1, 100};
        soundCrashes[]           = {"soundGeneralCollision1", 0.330000, "soundGeneralCollision2", 0.330000, "soundGeneralCollision3", 0.330000};
        soundEngineOffExt[]      = {"fza_ah64_control\audio\Ext_Off.ogg",1,0.6,300};
        soundEngineOffInt[]      = {"emptySound", 0};
        soundEngineOnExt[]       = {"fza_ah64_control\audio\Ext_Start.ogg",1,0.6,300};
        soundEngineOnInt[]       = {"fza_ah64_control\audio\Int_Start.ogg",1,0.6};
        soundenviron[]           = {"", 1, 1};
        ...
        tailDamageInt[]          = {"\fza_ah64_control\audio\Tail_Damage.ogg", 1.000000, 1.000000};
        tailDamageOut[]          = {"\fza_ah64_control\audio\Tail_Damage.ogg", 1.000000, 1.000000, 100};
        threat[]                 = {1,1,0.5};
