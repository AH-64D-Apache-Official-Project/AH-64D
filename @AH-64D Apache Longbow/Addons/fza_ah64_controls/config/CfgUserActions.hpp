...
class CfgUserActions
{
    ...
    CfgUserActionDef(fza_ah64_forceTrimHoldModeSwitch_up, "Force Trim/Hold Mode Switch Up", "Trim the helicopter to the current position of the cyclic stick and if held interrupts the heading hold");
