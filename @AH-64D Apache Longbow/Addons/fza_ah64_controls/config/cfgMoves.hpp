...
class CfgMovesMaleSdr: CfgMovesBasic
{
    class States
    {
        ...
        class fza_ah64_leftcargo_dead: DefaultDie
        {
            ...
            looped = "false";
            terminal = 1;
            file = "\fza_ah64_model\anim\fza_ah64_leftcargo_dead.rtm";
            connectTo[] = {"DeadState",0.1};
        };
        class fza_ah64_leftcargo: Crew
        {
            file = "\fza_ah64_model\anim\fza_ah64_leftcargo.rtm";
        ...
        class fza_ah64_rightcargo_dead: DefaultDie
        {
            ...
            looped = "false";
            terminal = 1;
            file = "\fza_ah64_model\anim\fza_ah64_rightcargo_dead.rtm";
            connectTo[] = {"DeadState",0.1};
        };
        class fza_ah64_rightcargo: Crew
        {
            file = "\fza_ah64_model\anim\fza_ah64_rightcargo.rtm";
            interpolateTo[] = {"fza_ah64_rightcargo_dead",1};
        };
        class fza_ah64_plt_movearm: Crew
        {
            file = "\fza_ah64_model\anim\fza_ah64_plt_movearm.rtm";
            interpolateTo[] = {};
            speed = 0.5;
            looped = 0;
        };
        ...
        {
            file = "\fza_ah64_model\anim\fza_ah64_pilot.rtm";
