class CfgMagazines
{
	...
	#define HELLFIRE_MAGAZINE_CONFIG_LASER(ammoname, disp, descShort) \
	...
	HELLFIRE_MAGAZINE_CONFIG_LASER(fza_agm114a, "AGM-114A", "Semi-active laser guided missile with an effective range out to 7km. The A variant was the first built, capable of destroying non-reactive armor threats.");
	HELLFIRE_MAGAZINE_CONFIG_LASER(fza_agm114c, "AGM-114C", "Semi-active laser guided missile with an effective range out to 7km. The C variant introduced an improved motor, seeker, and autopilot over the A variant.");
	HELLFIRE_MAGAZINE_CONFIG_LASER(fza_agm114k, "AGM-114K", "Semi-active laser guided missile with an effective range out to 7km. This is the most advanced model of all the laser guided HELLFIRES available.");
	HELLFIRE_MAGAZINE_CONFIG_LASER(fza_agm114m, "AGM-114M", "Semi-active laser guided missile with an effective range out to 7km, with a blast-fragmentation warhead. It is ideal for soft targets.");
	HELLFIRE_MAGAZINE_CONFIG_LASER(fza_agm114n, "AGM-114N", "Semi-active laser guided missile with an effective range out to 7km, with a thermobaric warhead. It is very deadly when used against hardened targets.");


	class PylonRack_4Rnd_ACE_Hellfire_AGM114L;
	#define HELLFIRE_MAGAZINE_CONFIG_RADAR(ammoname, disp, descShort) \
		class ammoname##_base: PylonRack_4Rnd_ACE_Hellfire_AGM114L {\
			descriptionShort = descShort;\
			ammo = ammoname;\
			displayName = disp; \
			count = 1; \
	...
	HELLFIRE_MAGAZINE_CONFIG_RADAR(fza_agm114l, "AGM-114L", "One of the most advanced anti-tank missiles in the world. Radar guided, it is capable of hitting targets out to 8km and can destroy any known armored vehicle in existence.");
