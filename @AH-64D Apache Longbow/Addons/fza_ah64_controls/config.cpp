...
class CfgPatches
{
	class fza_ah64_controls
	{
		...
		requiredAddons[] = {"A3_Air_F_Beta","A3_Sounds_F","A3_Data_F", "cba_main", "cba_xeh", "fza_ah64_sfmplus", "fza_ah64_aiCrew", "fza_ah64_audio"};
	};
};
class CfgAddons
{
	...
	class PreloadAddons
	{
		...
		{
<<<<<<< HEAD
			list[] = {"fza_ah64_controls", "fza_ah64_sfmplus", "fza_ah64_AICrew", "fza_ah64_dms", "fza_ah64_ku", "fza_ah64_mpd", "fza_ah64_ufd", "fza_ah64_audio"};
=======
			list[] = {"fza_ah64_controls", "fza_ah64_sfmplus", "fza_ah64_AICrew","fza_ah64_Misc"};
>>>>>>> b740b8cd (Init)
		};
	};
};
