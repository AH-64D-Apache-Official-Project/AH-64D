...
class CfgPatches
{
    class fza_ah64_controls
    {
        ...
        requiredAddons[] = {"A3_Air_F_Beta_Heli_Transport_01","A3_Air_F_Beta","A3_Sounds_F","A3_Data_F", "cba_main", "cba_xeh", "fza_ah64_sfmplus", "fza_ah64_aiCrew", "fza_ah64_audio", "fza_ah64_ihadss", "fza_ah64_fcr"};
        version = 2.2.7;
        versionStr = "2.2.7";
        versionAr[] = {2, 2, 7};
    };
