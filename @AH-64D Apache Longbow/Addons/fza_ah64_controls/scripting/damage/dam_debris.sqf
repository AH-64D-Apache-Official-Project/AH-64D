...
if (_part == "tailboom") then {
    //fx
    drop[["\A3\data_f\ParticleEffects\Universal\Universal", 16, 12, 9, 1], "", "Billboard", 0.5, 4, [0, -4, -2], [0, 0, 0], 0, 0.6, 0.5, 0, [4, 8], [
        [0.01, 0.01, 0.01, 1],
        [0.01, 0.01, 0.01, 1],
        [0.01, 0.01, 0.01, 0.9],
        [0.01, 0.01, 0.01, 0.8],
    ...
    drop[["\A3\data_f\ParticleEffects\Universal\Universal", 16, 13, 2, 0], "", "Billboard", 0.5, 4, [0, -4, -2], [(random 5) + (random - 5), (random 5) + (random - 5), (random 5) + (random - 5)], 0, 1, 0.1, 0, [0.5], [
        [1, 1, 1, -7]
    ], [1000], 0.1, 0.2, "", "", _heli];
    drop[["\A3\data_f\ParticleEffects\Universal\Universal", 16, 13, 2, 0], "", "Billboard", 0.5, 4, [0, -4, -2], [(random 5) + (random - 5), (random 5) + (random - 5), (random 5) + (random - 5)], 0, 1, 0.1, 0, [0.5], [
        [1, 1, 1, -7]
    ...
    if (local _heli) then {
        ...
        _vtail = "fza_ah64_vtail_debris"
        createvehicle[(getpos _heli select 0), (getpos _heli select 1), (getpos _heli select 2)];
