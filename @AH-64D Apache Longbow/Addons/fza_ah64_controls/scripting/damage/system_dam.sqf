...
{
	if(_damage >= 0.2 && !("fza_ah64_dam_reng" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_reng",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_reng" in _mags)) then
	{
		_heli addmagazineturret ["fza_ah64_mdam_reng",[-1]];
		if(!("fza_ah64_e2_fire" in _mags)) then {[_heli,"right"] execvm "\fza_ah64_controls\scripting\damage\enginefire.sqf";};
		_rand = round(random 10);
		if(_rand == 5 && !("fza_ah64_fwd_leak" in _mags)) then {_heli addmagazineturret ["fza_ah64_fwd_leak",[-1]]; [_heli] execvm "\fza_ah64_controls\scripting\damage\fuel_leak.sqf";};
		if(_rand == 10 && !("fza_ah64_aft_leak" in _mags)) then {_heli addmagazineturret ["fza_ah64_aft_leak",[-1]]; [_heli] execvm "\fza_ah64_controls\scripting\damage\fuel_leak.sqf";};
	};
...
{
	if(_damage >= 0.2 && !("fza_ah64_dam_lfab" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_lfab",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_lfab" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_lfab",[-1]]; [_heli,_system] call fza_ah64_processdamage;};
};

if(_system == "rfab") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_rfab" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_rfab",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_rfab" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_rfab",[-1]]; [_heli,_system] call fza_ah64_processdamage;};
};

if(_system == "lwing") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_lwing" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_lwing",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_lwing" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_lwing",[-1]]; [_heli,_system] call fza_ah64_weapondamage;};
};

if(_system == "rwing") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_rwing" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_rwing",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_rwing" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_rwing",[-1]]; [_heli,_system] call fza_ah64_weapondamage;};
};

if(_system == "tailboom") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_tailboom" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_tailboom",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_tailboom" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_tailboom",[-1]];};
	if(_damage >= 0.95 && !("fza_ah64_cdam_tailboom" in _mags)) then {_heli addmagazineturret ["fza_ah64_cdam_tailboom",[-1]]; _heli sethit ["mala vrtule",1]; [_heli,_system] execvm "\fza_ah64_controls\scripting\damage\dam_debris.sqf";};
};

if(_system == "vtail") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_vtail" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_vtail",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_vtail" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_vtail",[-1]];};
};

if(_system == "hstab") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_hstab" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_hstab",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_hstab" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_hstab",[-1]];};
};

if(_system == "pylon1") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_pylon1" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_pylon1",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_pylon1" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_pylon1",[-1]]; [_heli,_system] call fza_ah64_weapondamage;};
};

if(_system == "pylon2") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_pylon2" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_pylon2",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_pylon2" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_pylon2",[-1]]; [_heli,_system] call fza_ah64_weapondamage;};
};

if(_system == "pylon3") then
{
	if(_damage >= 0.2 && !("fza_ah64_dam_pylon3" in _mags)) then {_heli addmagazineturret ["fza_ah64_dam_pylon3",[-1]];};
	if(_damage >= 0.4 && !("fza_ah64_mdam_pylon3" in _mags)) then {_heli addmagazineturret ["fza_ah64_mdam_pylon3",[-1]]; [_heli,_system] call fza_ah64_weapondamage;};
};
