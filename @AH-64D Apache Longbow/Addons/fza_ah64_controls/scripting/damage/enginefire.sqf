...
if(_eng == "left") then {_side = [-1, -0.8, -1.25]; _sidef = [-1, -0.6, -1.25]; _mag = "fza_ah64_e1_fire"; _audio1 = "fza_ah64_bt_engine1";};
if(_eng == "apu") then {_side = [0, -0.8, -1.25]; _sidef = [0, 0.2, -1.25]; _mag = "fza_ah64_apu_fire"; _audio1 = "fza_ah64_bt_apu";};

_heli addmagazineturret [_mag,[-1]];

_smokefx = "#particlesource" createVehiclelocal getpos _heli;
_smokefx attachto [_heli,[0,0,0]];

_firefx = "#particlesource" createVehiclelocal getpos _heli;
...
_smokefx setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal", 16, 12, 9, 1], "", "Billboard", 1, 3, _side, [0, 0, 1], 0, 10, 7.9, 0.066, [2, 3, 4], [[0.1, 0.1, 0.1, 1], [0.2, 0.2, 0.2, 0.5], [0.3, 0.3, 0.3, 0]], [0.125], 1, 0, "", "", _heli];
...
_firefx setParticleParams [["\A3\data_f\ParticleEffects\Universal\Universal", 16, 10, 32, 1], "", "Billboard", 1, 0.2, _sidef, [0, 0, 0.5], 5, 1, 0.9, 0.3, [1],[[1,1,1,1],[1,1,1,0.75],[1,1,1,0]], [0.5,0.5,0], 0.5, 0.5, "", "", _heli];

if(_usesound) then {[_audio1,1.25,"fza_ah64_bt_fire",0.65] execvm "\fza_ah64_controls\scripting\damage\dam_bt_audio.sqf";};
...
if(_helidamage > 0.5) then {_heli setHit ["trans", 1];};
if(_helidamage > 1) then {_heli setdamage 1;};
sleep 0.1;
};
