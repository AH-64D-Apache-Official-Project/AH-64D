...
if (isNil "fza_ah64_fx_init") then
{
	...
	fza_ah64_fx_EH_Fired = compile preprocessFileLineNumbers "\ca\Data\ParticleEffects\SCRIPTS\fired.sqf";
	...
	if(isNil "fza_ah64_mycurrenttarget") then {fza_ah64_mycurrenttarget = null;};
	...
	fza_ah64_schedarray = [fza_ah64_pnvscontrol,fza_ah64_worldtoscreen,fza_ah64_targetcycle,fza_ah64_slipcheck,fza_ah64_timetowp,fza_ah64_rotordam];
	fza_ah64_asemisarray = [];
};

_enginetracker = [_heli] execvm "\fza_ah64_controls\scripting\func_engines.sqf";
_weapontracker = [_heli] execvm "\fza_ah64_controls\scripting\page_wpn.sqf";
_wcatracker = [_heli] execvm "\fza_ah64_controls\scripting\page_wca.sqf";
_flttracker = [_heli] execvm "\fza_ah64_controls\scripting\page_flt.sqf";
_engtracker = [_heli] execvm "\fza_ah64_controls\scripting\page_eng.sqf";
_asetracker = [_heli] execvm "\fza_ah64_controls\scripting\page_ase.sqf";
_ufdtracker = [_heli] execvm "\fza_ah64_controls\scripting\ufd.sqf";
...
{
	_heli setobjecttexture [274,"\fza_ah64_us\tex\wpn1_co.paa"];
...
{
	_heli setobjecttexture [275,"\fza_ah64_us\tex\wpn1_co.paa"];
...
{
	_heli setobjecttexture [276,"\fza_ah64_us\tex\wpn1_co.paa"];
...
{
	_heli setobjecttexture [277,"\fza_ah64_us\tex\wpn1_co.paa"];
...
{
	_heli setobjecttexture [270,"\fza_ah64_us\tex\wpn1_co.paa"];
	...
	if(_pod1rocket <= 0) then {_pod1rocket = _beg1;};
	if(_amount == _fullcount && ((_pod1rocket - _beg1) <= _fullcount)) then
	{
		if (_pod1rocket < _end1) then
		{
		_heli setobjecttexture [_pod1rocket,"\fza_ah64_us\tex\wpn1_co.paa"];
		_pod1rocket = _pod1rocket + 1;
		};
	};
	if(_amount < _fullcount) then
	{
		if ((_pod1rocket - _beg1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [_pod1rocket,""];
		_pod1rocket = _pod1rocket - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_1_zone1") then
{
	...
	if (_pod1rocket1 <= 0) then {_pod1rocket1 = 0;};
	if (_amount > 0 && !(_pod1rocket1 >= _amount)) then
	{
		if (_pod1rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod1rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod1rocket1 = _pod1rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod1rocket1 > -1) then
	{
		if ((_pod1rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod1rocket1)),""];
		if (_pod1rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [3,22,41];};
		_pod1rocket1 = _pod1rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_1_zone2") then
{
	...
	if (_pod1rocket2 <= 0) then {_pod1rocket2 = 0;};
	if (_amount > 0 && !(_pod1rocket2 >= _amount)) then
	{
		if (_pod1rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod1rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod1rocket2 = _pod1rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod1rocket2 > -1) then
	{
		if ((_pod1rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod1rocket2)),""];
		if (_pod1rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [5,24,43];};
		_pod1rocket2 = _pod1rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_1_zone3") then
{
	...
	if (_pod1rocket3 <= 0) then {_pod1rocket3 = 0;};
	if (_amount > 0 && !(_pod1rocket3 >= _amount)) then
	{
		if (_pod1rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod1rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod1rocket3 = _pod1rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod1rocket3 > -1) then
	{
		if (_pod1rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod1rocket3)),""];
		if (_pod1rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [0,19,38];};
		_pod1rocket3 = _pod1rocket3 - 1;
		};
	};
};
...
{
	_heli setobjecttexture [271,"\fza_ah64_us\tex\wpn1_co.paa"];
...
if(_heli hasweapon "fza_m261_2_zone1") then
{
	...
	if (_pod2rocket1 <= 0) then {_pod2rocket1 = 0;};
	if (_amount > 0 && !(_pod2rocket1 >= _amount)) then
	{
		if (_pod2rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod2rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod2rocket1 = _pod2rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod2rocket1 > -1) then
	{
		if ((_pod2rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod2rocket1)),""];
		if (_pod2rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [60,79,98];};
		_pod2rocket1 = _pod2rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_2_zone2") then
{
	...
	if (_pod2rocket2 <= 0) then {_pod2rocket2 = 0;};
	if (_amount > 0 && !(_pod2rocket2 >= _amount)) then
	{
		if (_pod2rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod2rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod2rocket2 = _pod2rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod2rocket2 > -1) then
	{
		if ((_pod2rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod2rocket2)),""];
		if (_pod2rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [62,81,100];};
		_pod2rocket2 = _pod2rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_2_zone3") then
{
	...
	if (_pod2rocket3 <= 0) then {_pod2rocket3 = 0;};
	if (_amount > 0 && !(_pod2rocket3 >= _amount)) then
	{
		if (_pod2rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod2rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod2rocket3 = _pod2rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod2rocket3 > -1) then
	{
		if (_pod2rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod2rocket3)),""];
		if (_pod2rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [57,76,95];};
		_pod2rocket3 = _pod2rocket3 - 1;
		};
	};
};
...
{
	_heli setobjecttexture [272,"\fza_ah64_us\tex\wpn1_co.paa"];
...
if(_heli hasweapon "fza_m261_3_zone1") then
{
	...
	if (_pod3rocket1 <= 0) then {_pod3rocket1 = 0;};
	if (_amount > 0 && !(_pod3rocket1 >= _amount)) then
	{
		if (_pod3rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod3rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod3rocket1 = _pod3rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod3rocket1 > -1) then
	{
		if ((_pod3rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod3rocket1)),""];
		if (_pod3rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [117,136,155];};
		_pod3rocket1 = _pod3rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_3_zone2") then
{
	...
	if (_pod3rocket2 <= 0) then {_pod3rocket2 = 0;};
	if (_amount > 0 && !(_pod3rocket2 >= _amount)) then
	{
		if (_pod3rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod3rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod3rocket2 = _pod3rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod3rocket2 > -1) then
	{
		if ((_pod3rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod3rocket2)),""];
		if (_pod3rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [118,137,156];};
		_pod3rocket2 = _pod3rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_3_zone3") then
{
	...
	if (_pod3rocket3 <= 0) then {_pod3rocket3 = 0;};
	if (_amount > 0 && !(_pod3rocket3 >= _amount)) then
	{
		if (_pod3rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod3rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod3rocket3 = _pod3rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod3rocket3 > -1) then
	{
		if (_pod3rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod3rocket3)),""];
		if (_pod3rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [114,133,152];};
		_pod3rocket3 = _pod3rocket3 - 1;
		};
	};
};
...
{
	_heli setobjecttexture [273,"\fza_ah64_us\tex\wpn1_co.paa"];
...
if(_heli hasweapon "fza_m261_4_zone1") then
{
	...
	if (_pod4rocket1 <= 0) then {_pod4rocket1 = 0;};
	if (_amount > 0 && !(_pod4rocket1 >= _amount)) then
	{
		if (_pod4rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod4rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod4rocket1 = _pod4rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod4rocket1 > -1) then
	{
		if ((_pod4rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod4rocket1)),""];
		if (_pod4rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [174,193,212];};
		_pod4rocket1 = _pod4rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_4_zone2") then
{
	...
	if (_pod4rocket2 <= 0) then {_pod4rocket2 = 0;};
	if (_amount > 0 && !(_pod4rocket2 >= _amount)) then
	{
		if (_pod4rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod4rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod4rocket2 = _pod4rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod4rocket2 > -1) then
	{
		if ((_pod4rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod4rocket2)),""];
		if (_pod4rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [175,194,213];};
		_pod4rocket2 = _pod4rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_4_zone3") then
{
	...
	if (_pod4rocket3 <= 0) then {_pod4rocket3 = 0;};
	if (_amount > 0 && !(_pod4rocket3 >= _amount)) then
	{
		if (_pod4rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod4rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod4rocket3 = _pod4rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod4rocket3 > -1) then
	{
		if (_pod4rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod4rocket3)),""];
		if (_pod4rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [171,190,209];};
		_pod4rocket3 = _pod4rocket3 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_14") then
{
	...
	if(_pod1rocket <= 0) then {_pod1rocket = _beg1;};
	if(_pod4rocket <= 0) then {_pod4rocket = _beg4;};
	if(_amount == _fullcount && ((_pod1rocket - _beg1 + _pod4rocket - _beg4) <= _fullcount)) then
	{
		if (_pod1rocket < _end1) then
		{
		_heli setobjecttexture [_pod1rocket,"\fza_ah64_us\tex\wpn1_co.paa"];
	...
	if(_amount < _fullcount) then
	{
		if ((_pod1rocket - _beg1) > ((floor (_amount * 0.5))-1)) then
		{
		_heli setobjecttexture [_pod1rocket,""];
		_pod1rocket = _pod1rocket - 1;
		};
		if ((_pod4rocket - _beg4) > ((floor (_amount * 0.5))-1)) then
		{
		_heli setobjecttexture [_pod4rocket,""];
		_pod4rocket = _pod4rocket - 1;
		};
...
if(_heli hasweapon "fza_m261_14_zoneA") then
{
	...
	if (_pod14rocket1 <= 0) then {_pod14rocket1 = 0;};
	if (_amount > 0 && !(_pod14rocket1 >= _amount)) then
	{
		if (_pod14rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod14rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod14rocket1 = _pod14rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod14rocket1 > -1) then
	{
		if ((_pod14rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod14rocket1)),""];
		if (_pod14rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [3,22,41];};
		_pod14rocket1 = _pod14rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_14_zoneB") then
{
	...
	if (_pod14rocket2 <= 0) then {_pod14rocket2 = 0;};
	if (_amount > 0 && !(_pod14rocket2 >= _amount)) then
	{
		if (_pod14rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod14rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod14rocket2 = _pod14rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod14rocket2 > -1) then
	{
		if ((_pod14rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod14rocket2)),""];
		if (_pod14rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [5,24,43];};
		_pod14rocket2 = _pod14rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_14_zoneE") then
{
	...
	if (_pod14rocket3 <= 0) then {_pod14rocket3 = 0;};
	if (_amount > 0 && !(_pod14rocket3 >= _amount)) then
	{
		if (_pod14rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod14rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod14rocket3 = _pod14rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod14rocket3 > -1) then
	{
		if (_pod14rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod14rocket3)),""];
		if (_pod14rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [0,19,38];};
		_pod14rocket3 = _pod14rocket3 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_23_zoneC") then
{
	...
	if (_pod23rocket1 <= 0) then {_pod23rocket1 = 0;};
	if (_amount > 0 && !(_pod23rocket1 >= _amount)) then
	{
		if (_pod23rocket1 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod23rocket1)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod23rocket1 = _pod23rocket1 + 1;
		};
	};
	if(_amount < _fullcount && _pod23rocket1 > -1) then
	{
		if ((_pod23rocket1) > ((_amount)-1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod23rocket1)),""];
		if (_pod23rocket1 == 0) then {{_heli setobjecttexture [_x,""];} foreach [60,79,98];};
		_pod23rocket1 = _pod23rocket1 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_23_zoneD") then
{
	...
	if (_pod23rocket2 <= 0) then {_pod23rocket2 = 0;};
	if (_amount > 0 && !(_pod23rocket2 >= _amount)) then
	{
		if (_pod23rocket2 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod23rocket2)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod23rocket2 = _pod23rocket2 + 1;
		};
	};
	if(_amount < _fullcount && _pod23rocket2 > -1) then
	{
		if ((_pod23rocket2) > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod23rocket2)),""];
		if (_pod23rocket2 == 0) then {{_heli setobjecttexture [_x,""];} foreach [62,81,100];};
		_pod23rocket2 = _pod23rocket2 - 1;
		};
	};
};
...
if(_heli hasweapon "fza_m261_23_zoneE") then
{
	...
	if (_pod23rocket3 <= 0) then {_pod23rocket3 = 0;};
	if (_amount > 0 && !(_pod23rocket3 >= _amount)) then
	{
		if (_pod23rocket3 < _amount) then
		{
			_heli setobjecttexture [(_zonearray select (_pod23rocket3)),"\fza_ah64_us\tex\wpn1_co.paa"];
			_pod23rocket3 = _pod23rocket3 + 1;
		};
	};
	if(_amount < _fullcount && _pod23rocket3 > -1) then
	{
		if (_pod23rocket3 > (_amount - 1)) then
		{
		_heli setobjecttexture [(_zonearray select (_pod23rocket3)),""];
		if (_pod23rocket3 <= 0) then {{_heli setobjecttexture [_x,""];} foreach [57,76,96];};
		_pod23rocket3 = _pod23rocket3 - 1;
		};
	};
};
	...
	_pod23rocket2 = 0;
	_pod23rocket3 = 0;
	if(_num > -1) then {_heli setobjecttexture [_num,""]; _num = _num - 1;};
};
