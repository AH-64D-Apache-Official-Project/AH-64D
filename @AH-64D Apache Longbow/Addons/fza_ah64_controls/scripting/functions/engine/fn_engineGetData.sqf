...
private _idleFlyTransition = [[ 0.0,  55.0, 67.9, 500.0, 70.0,   7.0], 
							  ...
							  [10.0,  75.0, 87.8, 571.0, 86.0,  22.0], 
							  [12.0,  80.0, 85.7, 552.0, 87.0,  30.0], 
							  [14.0,  84.0, 84.2, 546.0, 88.0,  31.0], 
							  [16.0,  88.0, 85.5, 556.0, 88.0,  28.0], 
							  [18.0,  92.0, 85.3, 542.0, 88.0,  21.0], 
							  [20.0,  96.0, 84.0, 542.0, 88.0,  17.0], 
							  [22.0, 100.0, 83.4, 541.0, 88.0,  15.0]];
//-----------------------------Time----NP----Ng----TGT---Oil----TQ
