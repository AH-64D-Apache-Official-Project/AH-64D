...
switch(_engine) do {
    case "eng1": {
        [_heli, "fza_ah64_fire1arm", _value] call fza_fnc_updateNetworkGlobal;
        _heli setObjectTextureGlobal ["in_lt_fire1rdy", ["", "\fza_ah64_us\tex\in\pushbut.paa"] select _value];
    };
    case "eng2": {
        [_heli, "fza_ah64_fire2arm", _value] call fza_fnc_updateNetworkGlobal;
        _heli setObjectTextureGlobal ["in_lt_fire2rdy", ["", "\fza_ah64_us\tex\in\pushbut.paa"] select _value];
    };
    case "apu": {
        [_heli, "fza_ah64_fireapuarm", _value] call fza_fnc_updateNetworkGlobal;
