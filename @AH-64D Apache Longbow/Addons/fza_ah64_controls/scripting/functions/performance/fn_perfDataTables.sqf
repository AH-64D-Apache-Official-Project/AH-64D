...
//_hvrTQ = [_hvrTQTable, _gwt_kg] call fza_fnc_linearInterp;

_hvrIGE = _hvrTQ select 1;
_hvrOGE = _hvrTQ select 2;

_gndEffMod = _hvrOGE / _hvrIGE;
//1.0 TQ = 481 N
