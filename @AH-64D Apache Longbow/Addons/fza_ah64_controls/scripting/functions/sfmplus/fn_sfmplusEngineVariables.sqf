...
_heli setVariable ["fza_ah64_engBaseTable",		[[	0.000,		0,		0.00,	0.00,	0.0000],		//Off
												 ...
												 [	0.355,    339,		0.00,	0.00,	0.0064],
												 [	0.407,    435,		0.00,	0.00,	0.0085],
												 [	0.455,    513,		0.00,	0.00,	0.0106],
												 [	0.548,    622,		0.00,	0.01,	0.0128],
												 [	0.643,    678,		0.00,	0.02,	0.0149],
												 [	0.670,    582,		0.00,	0.03,	0.0170],
												 [	0.672,    485,		0.00,	0.12,	0.0191],
												 [	0.675,    479,		0.00,	0.20,	0.0213],
												 [	0.677,    486,		0.03,	0.37,	0.0234],
												 [	0.679,    500,		0.07,	0.55,	0.0255],		//Idle
												 [	0.698,    525,		0.08,	0.59,	0.0276],
												 [	0.718,    550,		0.09,	0.63,	0.0298],
												 [	0.737,    566,		0.10,	0.67,	0.0319],
												 [	0.757,    564,		0.11,	0.71,	0.0340],
												 [	0.776,    571,		0.12,	0.78,	0.0361],
												 [	0.795,    552,		0.13,	0.82,	0.0383],
												 [	0.815,    546,		0.14,	0.95,	0.0404],
												 [	0.834,    541,		0.15,	1.01,	0.0425]]];	//Fly
...
_heli setVariable ["fza_ah64_engCruiseTable",	[[5897, 0.48, 0.39, 0.34, 0.34, 0.40, 0.44, 0.62, 0.72, 1.03],
