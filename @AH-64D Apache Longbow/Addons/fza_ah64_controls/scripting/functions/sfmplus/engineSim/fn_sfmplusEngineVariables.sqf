...
_heli setVariable ["fza_ah64_engBaseOilPSI",	   [0.0, 0.0]];
_heli setVariable ["fza_ah64_engOilPSI",		   [0.0, 0.0]];
_heli setVariable ["fza_ah64_engDst", 			   [false, false]];

//--------------------------------------------0-NG-----1-TGT----2-TQ----3-NP----4-Oil
_heli setVariable ["fza_ah64_engBaseTable",	[[0.000,	  0,	0.00,	0.00,	0.00],		//Off
