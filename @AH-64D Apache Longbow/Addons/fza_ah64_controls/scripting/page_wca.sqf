...
do {
    ...
    if (fza_ah64_pl_mpd == "wca" || fza_ah64_pr_mpd == "wca") then {
        ...
        if (fza_ah64_pr_mpd == "wca") then {
            _start = 551;
            _end = 576;
            _heli setobjecttexture [SEL_PR_MPD_BACK, "\fza_ah64_us\tex\MPD\WCA.paa"];
            ...
            _heli setobjecttexture [SEL_PR_WCA_1, ""];
            _heli setobjecttexture [SEL_PR_WCA_2, ""];
            _heli setobjecttexture [SEL_PR_WCA_3, ""];
            _heli setobjecttexture [SEL_PR_WCA_4, ""];
            _heli setobjecttexture [SEL_PR_WCA_5, ""];
            _heli setobjecttexture [SEL_PR_WCA_6, ""];
            _heli setobjecttexture [SEL_PR_WCA_7, ""];
            _heli setobjecttexture [SEL_PR_WCA_8, ""];
            _heli setobjecttexture [SEL_PR_WCA_9, ""];
            _heli setobjecttexture [SEL_PR_WCA_10, ""];
            _heli setobjecttexture [SEL_PR_WCA_11, ""];
            _heli setobjecttexture [SEL_PR_WCA_12, ""];
            _heli setobjecttexture [SEL_PR_WCA_13, ""];
            _heli setobjecttexture [SEL_PR_WCA_14, ""];
            _heli setobjecttexture [SEL_PR_WCA_15, ""];
            _heli setobjecttexture [SEL_PR_WCA_16, ""];
            _heli setobjecttexture [SEL_PR_WCA_17, ""];
            _heli setobjecttexture [SEL_PR_WCA_18, ""];
            _heli setobjecttexture [SEL_PR_WCA_19, ""];
            _heli setobjecttexture [SEL_PR_WCA_20, ""];
            _heli setobjecttexture [SEL_PR_WCA_21, ""];
            _heli setobjecttexture [SEL_PR_WCA_22, ""];
            _heli setobjecttexture [SEL_PR_WCA_23, ""];
            _heli setobjecttexture [SEL_PR_WCA_24, ""];
            _heli setobjecttexture [SEL_PR_WCA_25, ""];
            _heli setobjecttexture [SEL_PR_WCA_26, ""];
        };
        if (fza_ah64_pl_mpd == "wca") then {
            _start = 578;
            _end = 603;
            _heli setobjecttexture [SEL_PL_MPD_BACK, "\fza_ah64_us\tex\MPD\WCA.paa"];
            _counter = count _damlist - 1;
            _selection = _start;
            while {
                (_counter >= 0 && _selection <= _end)
            ...
            _heli setobjecttexture [SEL_PL_WCA_PG, ""];
            _heli setobjecttexture [SEL_PL_WCA_1, ""];
            _heli setobjecttexture [SEL_PL_WCA_2, ""];
            _heli setobjecttexture [SEL_PL_WCA_3, ""];
            _heli setobjecttexture [SEL_PL_WCA_4, ""];
            _heli setobjecttexture [SEL_PL_WCA_5, ""];
            _heli setobjecttexture [SEL_PL_WCA_6, ""];
            _heli setobjecttexture [SEL_PL_WCA_7, ""];
            _heli setobjecttexture [SEL_PL_WCA_8, ""];
            _heli setobjecttexture [SEL_PL_WCA_9, ""];
            _heli setobjecttexture [SEL_PL_WCA_10, ""];
            _heli setobjecttexture [SEL_PL_WCA_11, ""];
            _heli setobjecttexture [SEL_PL_WCA_12, ""];
            _heli setobjecttexture [SEL_PL_WCA_13, ""];
            _heli setobjecttexture [SEL_PL_WCA_14, ""];
            _heli setobjecttexture [SEL_PL_WCA_15, ""];
            _heli setobjecttexture [SEL_PL_WCA_16, ""];
            _heli setobjecttexture [SEL_PL_WCA_17, ""];
            _heli setobjecttexture [SEL_PL_WCA_18, ""];
            _heli setobjecttexture [SEL_PL_WCA_19, ""];
            _heli setobjecttexture [SEL_PL_WCA_20, ""];
            _heli setobjecttexture [SEL_PL_WCA_21, ""];
            _heli setobjecttexture [SEL_PL_WCA_22, ""];
            _heli setobjecttexture [SEL_PL_WCA_23, ""];
            _heli setobjecttexture [SEL_PL_WCA_24, ""];
            _heli setobjecttexture [SEL_PL_WCA_25, ""];
            _heli setobjecttexture [SEL_PL_WCA_26, ""];
        };
    } else {
        _heli setobjecttexture [SEL_PR_WCA_PG, ""];
        _heli setobjecttexture [SEL_PR_WCA_1, ""];
        _heli setobjecttexture [SEL_PR_WCA_2, ""];
        _heli setobjecttexture [SEL_PR_WCA_3, ""];
        _heli setobjecttexture [SEL_PR_WCA_4, ""];
