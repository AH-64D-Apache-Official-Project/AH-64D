...

{
    ...
    if ((fza_ah64_agmode == 1 && getpos _i select 2 < 50) || (_theta > 45 && _theta < 315) || (fza_ah64_agmode == 0 && getpos _i select 2 > 50) || (((_heli distance _i) * rangesetting) > 1) || !(alive _i)) then {
        fza_ah64_tsdtargets = fza_ah64_tsdtargets - [_i];
    };
    if ((((_heli distance _i) * rangesetting > 0.2) && (_theta > 90 && _theta < 270)) || ((_heli distance _i) * rangesetting > 1) || !(alive _i)) then {
        fza_ah64_tsddisptargs = fza_ah64_tsddisptargs - [_i];
    };
}
