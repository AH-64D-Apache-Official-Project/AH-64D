...
{
if(_heli animationphase "plt_batt" > 0.5) exitwith {fza_ah64_pwron = 0; ["fza_ah64_battery",0.1] execvm "\fza_ah64_controls\scripting\damage\dam_bt_audio.sqf"; fza_ah64_l1clicked = 1;};
...
{
if(_heli animationphase "plt_batt" < 1) then {_heli animate ["plt_batt",1]; ["fza_ah64_switch_flip1",0.1] execvm "\fza_ah64_controls\scripting\damage\dam_bt_audio.sqf";
} else {
_heli animate ["plt_batt",0]; ["fza_ah64_switch_flip1",0.1] execvm "\fza_ah64_controls\scripting\damage\dam_bt_audio.sqf";};
fza_ah64_l1clicked = 1;
};
...
if(_heli animationphase "plt_batt" > 0.5 && fza_ah64_apuon == 1 && _heli animationphase "plt_eng1_start" == 1 && _heli animationphase "plt_eng1_throttle" > 0.10 && _heli animationphase "plt_rtrbrake" == 0) then
{
...
if(_heli animationphase "plt_batt" > 0.5 && _heli animationphase "plt_eng1_throttle" == 0 && _heli animationphase "plt_eng2_throttle" == 0 && isEngineOn _heli) then 
{
