...
if(fza_ah64_mousehorpos > (safezoneXabs + safezonew)) then {fza_ah64_mousehorpos = safezoneXabs + safezonew;};
if(fza_ah64_mousehorpos < safezoneXabs) then {fza_ah64_mousehorpos = safezoneXabs;};
if(fza_ah64_mousevertpos > (safezoneY + safezoneH)) then {fza_ah64_mousevertpos = safezoneY + safezoneH;};
if(fza_ah64_mousevertpos < safezoneY) then {fza_ah64_mousevertpos = safezoneY;};
