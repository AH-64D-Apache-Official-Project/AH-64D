...
if (player == gunner _heli) then {
    _btnt1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_t1");
};
_btnt1 = worldtoscreen _btnt1;
if (count _btnt1 < 2) then {
    _btnt1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l1");
};
_btnl1 = worldtoscreen _btnl1;
if (count _btnl1 < 2) then {
    _btnl1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l2");
};
_btnl2 = worldtoscreen _btnl2;
if (count _btnl2 < 2) then {
    _btnl2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l3");
};
_btnl3 = worldtoscreen _btnl3;
if (count _btnl3 < 2) then {
    _btnl3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l4");
};
_btnl4 = worldtoscreen _btnl4;
if (count _btnl4 < 2) then {
    _btnl4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl5 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l5");
};
_btnl5 = worldtoscreen _btnl5;
if (count _btnl5 < 2) then {
    _btnl5 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnl6 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_l6");
};
_btnl6 = worldtoscreen _btnl6;
if (count _btnl6 < 2) then {
    _btnl6 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnb1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_b1");
};
_btnb1 = worldtoscreen _btnb1;
if (count _btnb1 < 2) then {
    _btnb1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnb3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_b3");
};
_btnb3 = worldtoscreen _btnb3;
if (count _btnb3 < 2) then {
    _btnb3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnb4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_b4");
};
_btnb4 = worldtoscreen _btnb4;
if (count _btnb4 < 2) then {
    _btnb4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r1");
};
_btnr1 = worldtoscreen _btnr1;
if (count _btnr1 < 2) then {
    _btnr1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r2");
};
_btnr2 = worldtoscreen _btnr2;
if (count _btnr2 < 2) then {
    _btnr2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r3");
};
_btnr3 = worldtoscreen _btnr3;
if (count _btnr3 < 2) then {
    _btnr3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r4");
};
_btnr4 = worldtoscreen _btnr4;
if (count _btnr4 < 2) then {
    _btnr4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr5 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r5");
};
_btnr5 = worldtoscreen _btnr5;
if (count _btnr5 < 2) then {
    _btnr5 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnr6 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_r6");
};
_btnr6 = worldtoscreen _btnr6;
if (count _btnr6 < 2) then {
    _btnr6 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfcr = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_fcr");
};
_btnfcr = worldtoscreen _btnfcr;
if (count _btnfcr < 2) then {
    _btnfcr = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnwpn = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_wpn");
};
_btnwpn = worldtoscreen _btnwpn;
if (count _btnwpn < 2) then {
    _btnwpn = [0, 0];
};
...
if (player == gunner _heli) then {
    _btntsd = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_tsd");
};
_btntsd = worldtoscreen _btntsd;
if (count _btntsd < 2) then {
    _btntsd = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnm = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_m");
};
_btnm = worldtoscreen _btnm;
if (count _btnm < 2) then {
    _btnm = [0, 0];
};
...
if (player == gunner _heli) then {
    _rmpdllc = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_rmpd_llc");
};
_rmpdllc = worldtoscreen _rmpdllc;
if (count _rmpdllc < 2) then {
    _rmpdllc = [0, 0];
};
...
if (player == gunner _heli) then {
    _ihadssbrt = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_ihadss_brt");
};
_ihadssbrt = worldtoscreen _ihadssbrt;
if (count _ihadssbrt < 2) then {
    _ihadssbrt = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l1");
};
_lbtnl1 = worldtoscreen _lbtnl1;
if (count _lbtnl1 < 2) then {
    _lbtnl1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l2");
};
_lbtnl2 = worldtoscreen _lbtnl2;
if (count _lbtnl2 < 2) then {
    _lbtnl2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l3");
};
_lbtnl3 = worldtoscreen _lbtnl3;
if (count _lbtnl3 < 2) then {
    _lbtnl3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l4");
};
_lbtnl4 = worldtoscreen _lbtnl4;
if (count _lbtnl4 < 2) then {
    _lbtnl4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl5 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l5");
};
_lbtnl5 = worldtoscreen _lbtnl5;
if (count _lbtnl5 < 2) then {
    _lbtnl5 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnl6 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_l6");
};
_lbtnl6 = worldtoscreen _lbtnl6;
if (count _lbtnl6 < 2) then {
    _lbtnl6 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r1");
};
_lbtnr1 = worldtoscreen _lbtnr1;
if (count _lbtnr1 < 2) then {
    _lbtnr1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r2");
};
_lbtnr2 = worldtoscreen _lbtnr2;
if (count _lbtnr2 < 2) then {
    _lbtnr2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r3");
};
_lbtnr3 = worldtoscreen _lbtnr3;
if (count _lbtnr3 < 2) then {
    _lbtnr3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r4");
};
_lbtnr4 = worldtoscreen _lbtnr4;
if (count _lbtnr4 < 2) then {
    _lbtnr4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr5 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r5");
};
_lbtnr5 = worldtoscreen _lbtnr5;
if (count _lbtnr5 < 2) then {
    _lbtnr5 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnr6 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_r6");
};
_lbtnr6 = worldtoscreen _lbtnr6;
if (count _lbtnr6 < 2) then {
    _lbtnr6 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnb1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_b1");
};
_lbtnb1 = worldtoscreen _lbtnb1;
if (count _lbtnb1 < 2) then {
    _lbtnb1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnb2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_b2");
};
_lbtnb2 = worldtoscreen _lbtnb2;
if (count _lbtnb2 < 2) then {
    _lbtnb2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnb3 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_b3");
};
_lbtnb3 = worldtoscreen _lbtnb3;
if (count _lbtnb3 < 2) then {
    _lbtnb3 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnb4 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_b4");
};
_lbtnb4 = worldtoscreen _lbtnb4;
if (count _lbtnb4 < 2) then {
    _lbtnb4 = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnwpn = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_wpn");
};
_lbtnwpn = worldtoscreen _lbtnwpn;
if (count _lbtnwpn < 2) then {
    _lbtnwpn = [0, 0];
};
...
if (player == gunner _heli) then {
    _lbtnm = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_lmpd_m");
};
_lbtnm = worldtoscreen _lbtnm;
if (count _lbtnm < 2) then {
    _lbtnm = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnbacklght = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_backlights");
};
_btnbacklght = worldtoscreen _btnbacklght;
if (count _btnbacklght < 2) then {
    _btnbacklght = [0, 0];
};
...
if (player == gunner _heli) then {
    _swfiretest = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_swfiretst");
};
_swfiretest = worldtoscreen _swfiretest;
if (count _swfiretest < 2) then {
    _swfiretest = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfire1 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_fe1");
};
_btnfire1 = worldtoscreen _btnfire1;
if (count _btnfire1 < 2) then {
    _btnfire1 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfireapu = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_fapu");
};
_btnfireapu = worldtoscreen _btnfireapu;
if (count _btnfireapu < 2) then {
    _btnfireapu = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfire2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_fe2");
};
_btnfire2 = worldtoscreen _btnfire2;
if (count _btnfire2 < 2) then {
    _btnfire2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfbp = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_fbp");
};
_btnfbp = worldtoscreen _btnfbp;
if (count _btnfbp < 2) then {
    _btnfbp = [0, 0];
};
...
if (player == gunner _heli) then {
    _btnfbr = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_fbr");
};
_btnfbr = worldtoscreen _btnfbr;
if (count _btnfbr < 2) then {
    _btnfbr = [0, 0];
};
...
if (player == gunner _heli) then {
    _pdoorhandle = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_doorhandle");
};
_pdoorhandle = worldtoscreen _pdoorhandle;
if (count _pdoorhandle < 2) then {
    _pdoorhandle = [0, 0];
};
...
if (player == gunner _heli) then {
    _pdoorhandle2 = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_doorhandle");
};
_pdoorhandle2 = worldtoscreen _pdoorhandle2;
if (count _pdoorhandle2 < 2) then {
    _pdoorhandle2 = [0, 0];
};
...
if (player == gunner _heli) then {
    _stowihadss = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_ihadss");
};
_stowihadss = worldtoscreen _stowihadss;
if (count _stowihadss < 2) then {
    _stowihadss = [0, 0];
};
...
if (player == gunner _heli) then {
    _stowmonocle = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_monocle");
};
_stowmonocle = worldtoscreen _stowmonocle;
if (count _stowmonocle < 2) then {
    _stowmonocle = [0, 0];
};
...
if (player == gunner _heli) then {
    _pnvsdnt = _heli modelToWorldVisual(_heli selectionposition "ctrlref_g_pnvs_dn");
};
_pnvsdnt = worldtoscreen _pnvsdnt;
if (count _pnvsdnt < 2) then {
    _pnvsdnt = [0, 0];
};

//HDU PNVS TOGGLE

_plt_pnvshdu = _heli modelToWorldVisual(_heli selectionposition "nvs_mode_sw");
_plt_pnvshdu = worldtoscreen _plt_pnvshdu;
if (count _plt_pnvshdu < 2) then {
    _plt_pnvshdu = [0, 0];
};

_cpg_pnvshdu = _heli modelToWorldVisual(_heli selectionposition "nvs_mode_swg");
_cpg_pnvshdu = worldtoscreen _cpg_pnvshdu;
if (count _cpg_pnvshdu < 2) then {
    _cpg_pnvshdu = [0, 0];
};
...
if (player == gunner _heli) then {
    _floodlights = _heli modelToWorldVisual(_heli selectionposition "cpg_flood");
};
_floodlights = worldtoscreen _floodlights;
if (count _floodlights < 2) then {
    _floodlights = [0, 0];
};
...
if (count _anticollision < 2) then {
    _anticollision = [0, 0];
};
...
if (_btnt1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD T1";
};
if (_btnl1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L1";
};
if (_btnl2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L2";
};
if (_btnl3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L3";
};
if (_btnl4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L4";
};
if (_btnl5 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L5";
};
if (_btnl6 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD L6";
};
if (_btnr1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R1";
};
if (_btnr2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R2";
};
if (_btnr3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R3";
};
if (_btnr4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R4";
};
if (_btnr5 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R5";
};
if (_btnr6 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD R6";
};
if (_btnb1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD B1";
};
if (_btnb3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD B3";
};
if (_btnb4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD B4";
};
if (_btnfcr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD FCR";
};
if (_btnwpn distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD WPN";
};
if (_btntsd distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD TSD";
};
if (_btnm distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD DMS Menu";
};

if (_lbtnl1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L1";
};
if (_lbtnl2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L2";
};
if (_lbtnl3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L3";
};
if (_lbtnl4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L4";
};
if (_lbtnl5 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L5";
};
if (_lbtnl6 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD L6";
};
if (_lbtnr1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R1";
};
if (_lbtnr2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R2";
};
if (_lbtnr3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R3";
};
if (_lbtnr4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R4";
};
if (_lbtnr5 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R5";
};
if (_lbtnr6 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD R6";
};
if (_lbtnb1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD B1";
};
if (_lbtnb2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD B2";
};
if (_lbtnb3 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD B3";
};
if (_lbtnb4 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD B4";
};
if (_lbtnwpn distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD WPN";
};
if (_lbtnm distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD DMS Menu";
};

if (_ihadssbrt distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "IHADSS Brightness";
};
if (_lbtnbrt distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "LMPD Brightness";
};
if (_rbtnbrt distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "RMPD Brightness";
};
if (_btnbacklght distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Backlighting Toggle";
};

if (_swfiretest distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Fire Panel Test";
};
if (_btnfire1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG1 Fire System Arm";
};
if (_btnfire2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG2 Fire System Arm";
};
if (_btnfireapu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "APU Fire System Arm";
};
if (_btnfbp distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Primary Fire Extinguisher";
};
if (_btnfbr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Reserve Fire Extinguisher";
};

if (_pdoorhandle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.05) then {
    _helpertext = "Door Handle";
};
if (_pdoorhandle2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.05) then {
    _helpertext = "Door Handle";
};
if (_stowihadss distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.05) then {
    _helpertext = "IHADSS Toggle";
};
if (_stowmonocle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.05) then {
    _helpertext = "Monocle Toggle";
};

if (_btnpwr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Battery Toggle";
};
if (_btnapu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.04) then {
    _helpertext = "APU Toggle";
};
if (_swrbrk distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "Rotor Brake Toggle";
};
if (_e1start distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG1 Starter";
};
if (_e2start distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG2 Starter";
};
if (_e1off distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG1 Throttle Off";
};
if (_e1idle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG1 Throttle Idle";
};
if (_e1fly distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG1 Throttle Fly";
};
if (_e2off distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG2 Throttle Off";
};
if (_e2idle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG2 Throttle Idle";
};
if (_e2fly distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "ENG2 Throttle Fly";
};

if (_pnvsdnt distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "PNVS HDU Day/Night Toggle";
};
if (_pnvshdu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015) then {
    _helpertext = "PNVS HDU Toggle";
};

if (fza_ah64_nohelpers == 1) then {
    _helpertext = "";
};
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnb1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015 && fza_ah64_pr_mpd == "tsd") then {
    if (fza_ah64_tsdmode == "NAV") exitwith {
        fza_ah64_tsdmode = "ATK";
        fza_ah64_l1clicked = 1;
    };
    if (fza_ah64_tsdmode == "ATK") exitwith {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfcr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015 && _heli animationphase "plt_batt" > 0.5) then {
    fza_ah64_pr_mpd = "fcr";
    fza_ah64_l1clicked = 1;
};
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btntsd distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015 && _heli animationphase "plt_batt" > 0.5) then {
    fza_ah64_pr_mpd = "tsd";
    fza_ah64_l1clicked = 1;
};
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _lbtnwpn distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.015 && _heli animationphase "plt_batt" > 0.5) then {
    fza_ah64_pl_mpd = "wpn";
    fza_ah64_l1clicked = 1;
};
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfire1 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.02 && _heli animationphase "plt_batt" > 0.5) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfire2 distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.02 && _heli animationphase "plt_batt" > 0.5) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfireapu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.02 && _heli animationphase "plt_batt" > 0.5) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfbp distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.02 && _heli animationphase "plt_batt" > 0.5) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnfbr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.02 && _heli animationphase "plt_batt" > 0.5) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _pdoorhandle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.05 && (_heli animationphase "pdoor" < 0.5 || _heli animationphase "gdoor" < 0.5)) then {
    if (player == gunner _heli) then {
        _doorscript = [_heli, "gdoor"] execvm "\fza_ah64_controls\scripting\door_toggle.sqf";
    } else {
        _doorscript = [_heli, "pdoor"] execvm "\fza_ah64_controls\scripting\door_toggle.sqf";
    };
    fza_ah64_l1clicked = 1;
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _btnpwr distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.03) then {
    if (_heli animationphase "plt_batt" < 1) then {

        _heli animate["plt_batt", 1];
        ["fza_ah64_battery", 0.1] execvm "\fza_ah64_controls\scripting\damage\dam_bt_audio.sqf";
...
if (_heli animationphase "plt_batt" < 1 && (isCollisionLightOn _heli || isLightOn _heli)) then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _plt_pnvshdu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.03) then {
    if (_heli animationphase "plt_nvsmode" < 1) then {
        _heli animate["plt_nvsmode", 1];
        ["fza_ah64_switch_flip1", 0.1] execvm "\fza_ah64_controls\scripting\pnvs_cam_set.sqf";
        _clicksound = ["fza_ah64_switch_flip3", 0.1];
        fza_ah64_l1clicked = 1;
    } else {
        _heli animate["plt_nvsmode", 0];
        ["fza_ah64_switch_flip1", 0.1] execvm "\fza_ah64_controls\scripting\pnvs_cam_set.sqf";
    };
    _clicksound = ["fza_ah64_switch_flip3", 0.1];
    fza_ah64_l1clicked = 1;
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _cpg_pnvshdu distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.03) then {
    if (_heli animationphase "cpg_nvsmode" < 1) then {
        _heli animate["cpg_nvsmode", 1];
        ["fza_ah64_switch_flip1", 0.1] execvm "\fza_ah64_controls\scripting\pnvs_cam_set.sqf";
        _clicksound = ["fza_ah64_switch_flip3", 0.1];
        fza_ah64_l1clicked = 1;
    } else {
        _heli animate["cpg_nvsmode", 0];
        ["fza_ah64_switch_flip1", 0.1] execvm "\fza_ah64_controls\scripting\pnvs_cam_set.sqf";
    };
    _clicksound = ["fza_ah64_switch_flip3", 0.1];
    fza_ah64_l1clicked = 1;
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _floodlights distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.03) then {
    ...
    if (isnil "fza_ah64_backlights") then {
...
if (inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _stowmonocle distance[fza_ah64_mousehorpos, fza_ah64_mousevertpos] < 0.15) then {
    _clicksound = ["fza_ah64_monoclebox", 0.1];
    fza_ah64_l1clicked = 1;
    [_heli] exec "\fza_ah64_controls\scripting\monocle.sqs";
};

//IHADSS ON/OFF (PREVIOUSLY BRIGHTNESS)
...
if(inputaction "User20" > 0.5 && fza_ah64_l1clicked == 0 && _ihadssbrt distance [fza_ah64_mousehorpos,fza_ah64_mousevertpos] < 0.03) then
{
if(_heli animationphase "cpg_ihadss_brt" < 1) then
{
_heli animate ["cpg_ihadss_brt",1];
} else {
_heli animate ["cpg_ihadss_brt",0];
...
if (fza_ah64_l1clicked == 1 && count _clicksound > 1) then {
