...
//////AUTOTRACK////////
		...
		{
			if(isNull fza_ah64_mycurrenttarget || fza_ah64_guncontrol == 1) then {_wPos = screentoworld [0.5,0.5]; _targvel = [0,0,0]; _targspeed = 0; _targasl = [(_wPos select 0),(_wPos select 1),(getTerrainHeightASL [(_wPos select 0),(_wPos select 1)])];} else {_wPos = fza_ah64_mycurrenttarget modelToWorldVisual (fza_ah64_mycurrenttarget selectionposition "zamerny"); _targvel = velocity fza_ah64_mycurrenttarget; _targspeed = speed fza_ah64_mycurrenttarget; _targasl = getposasl fza_ah64_mycurrenttarget;};
			_helipos = _heli modelToWorldVisual (_heli selectionposition "usti hlavne");
			if(_targasl select 2 < 0) then {_targasl = [(_targasl select 0),(_targasl select 1),0];};
...
*/
			...
			_toffactor = 850;
			_rktavgvel = 1260;
			if(_heli distance _targasl > 90) then {_powerfactor = 1.99; _toffactor = 840; _distfactor = 3; _rktavgvel = 1060;};
			if(_heli distance _targasl > 190) then {_powerfactor = 1.9895; _toffactor = 835; _distfactor = 3; _rktavgvel = 1060;};
			if(_heli distance _targasl > 290) then {_powerfactor = 1.989; _toffactor = 830; _distfactor = 3; _rktavgvel = 1060;};
			if(_heli distance _targasl > 390) then {_powerfactor = 1.9885; _toffactor = 825; _distfactor = 3; _rktavgvel = 1060;};
			if(_heli distance _targasl > 490) then {_powerfactor = 1.988; _toffactor = 820; _distfactor = 3.5; _rktavgvel = 1060;};
			if(_heli distance _targasl > 590) then {_powerfactor = 1.9875; _toffactor = 815; _distfactor = 5.3; _rktavgvel = 1060;};
			if(_heli distance _targasl > 690) then {_powerfactor = 1.987; _toffactor = 810; _distfactor = 5.6; _rktavgvel = 1060;};
			if(_heli distance _targasl > 790) then {_powerfactor = 1.9865; _toffactor = 805; _distfactor = 5.9; _rktavgvel = 1060;};
			if(_heli distance _targasl > 890) then {_powerfactor = 1.986; _toffactor = 800; _distfactor = 6; _rktavgvel = 1060;};
			if(_heli distance _targasl > 990) then {_powerfactor = 1.9855; _toffactor = 795; _distfactor = 7; _rktavgvel = 1060;};
			if(_heli distance _targasl > 1090) then {_powerfactor = 1.985; _toffactor = 790; _distfactor = 9; _rktavgvel = 1010;};
			if(_heli distance _targasl > 1190) then {_powerfactor = 1.9845; _toffactor = 785; _distfactor = 10; _rktavgvel = 950;};
			if(_heli distance _targasl > 1290) then {_powerfactor = 1.984; _toffactor = 780; _distfactor = 11; _rktavgvel = 850;};
			if(_heli distance _targasl > 1390) then {_powerfactor = 1.9833; _toffactor = 775; _distfactor = 12; _rktavgvel = 800;};
			if(_heli distance _targasl > 1490) then {_powerfactor = 1.9826; _toffactor = 770; _distfactor = 13.2; _rktavgvel = 700;};
			if(_heli distance _targasl > 1740) then {_powerfactor = 1.9819; _toffactor = 760; _distfactor = 14; _rktavgvel = 650;};
			if(_heli distance _targasl > 1990) then {_powerfactor = 1.981; _toffactor = 740; _distfactor = 17; _rktavgvel = 640;};
			if(_heli distance _targasl > 2050) then {_powerfactor = 1.98; _toffactor = 720; _distfactor = 18; _rktavgvel = 620;};
			if(_heli distance _targasl > 2150) then {_powerfactor = 1.978; _toffactor = 700; _distfactor = 20; _rktavgvel = 610;};
			if(_heli distance _targasl > 2250) then {_powerfactor = 1.977; _toffactor = 680; _distfactor = 21; _rktavgvel = 600;};
			if(_heli distance _targasl > 2500) then {_powerfactor = 1.976; _toffactor = 660; _distfactor = 23.3; _rktavgvel = 580;};
			if(_heli distance _targasl > 2900) then {_powerfactor = 1.974; _distfactor = 31.5; _rktavgvel = 360;};
			if(_heli distance _targasl > 3400) then {_powerfactor = 1.972; _distfactor = 40.9; _rktavgvel = 320;};
			if(_heli distance _targasl > 3900) then {_powerfactor = 1.965;_distfactor = 54; _rktavgvel = 280;};
			if(_heli distance _targasl > 4400) then {_powerfactor = 1.95; _distfactor = 67; _rktavgvel = 230;};
			...
			if(_helidir > 180) then {_helidir = _helidir - 360;};
			...
			if(_azimuth > 0) then {_gunbank = _bank * -1;};
			if(_azimuth <= 0) then {_gunbank = _bank;};
			...
			if(!(isengineon _heli)) then {_pylonelev = 0; _elevation = -7; _azimuth = 0;};
			if("fza_ah64_gun_fail" in (_heli magazinesturret [-1]) || ("fza_ah64_rwp_fail" in (_heli magazinesturret [-1]) && "fza_ah64_lwp_fail" in (_heli magazinesturret [-1]))) then {_azimuth = 0; _elevation = -10;};
			if(_elevation > 55) then {_elevation = 55;};
			if(_elevation < -15) then {_elevation = -15;};
			if(_azimuth < -120) then {_azimuth = -120;};
			if(_azimuth > 120) then {_azimuth = 120;};
			if(_pylonelev > 10) then {_pylonelev = 10;};
			if(_pylonelev < -10) then {_pylonelev = -10;};
			if("fza_ah64_rwp_fail" in (_heli magazinesturret [-1]) && "fza_ah64_lwp_fail" in (_heli magazinesturret [-1])) then {_pylonelev = 5.07;};
			fza_ah64_pylonelev1 = _pylonelev;
			fza_ah64_pylonelev2 = _pylonelev;
			fza_ah64_pylonelev3 = _pylonelev;
			fza_ah64_pylonelev4 = _pylonelev;
			if("fza_auxtank_230_1" in magazines _heli) then {fza_ah64_pylonelev1 = 5;};
			if("fza_auxtank_230_2" in magazines _heli) then {fza_ah64_pylonelev2 = 5;};
			if("fza_auxtank_230_3" in magazines _heli) then {fza_ah64_pylonelev3 = 5;};
			if("fza_auxtank_230_4" in magazines _heli) then {fza_ah64_pylonelev4 = 5;};
...
/////////////NORM////////
		if(((fza_ah64_guncontrol == 0 || fza_ah64_guncontrol == 3) && (local gunner _heli || (isNull gunner _heli && local _heli) || (local _heli && !(alive gunner _heli)))) || (!(gunner _heli == player || driver _heli == player) && (local _heli))) then
		{
			...
			if(fza_ah64_turdir < -1.5) then {fza_ah64_turdir = -1.5};
			if(fza_ah64_turelev > 0.2) then {fza_ah64_turelev = 0.2};
			if(fza_ah64_turelev < -1) then {fza_ah64_turelev = -1};
			...
			if(fza_ah64_guncontrol == 3 && (gunner _heli == player || driver _heli == player) || !(isengineon _heli)) then {_curcontrol = 0; _curguncontrol = 0.17;};
			if(currentweapon _heli in fza_ah64_rocketweps14 || currentweapon _heli in fza_ah64_rocketweps23 || currentweapon _heli in fza_ah64_rocketweps1 || currentweapon _heli in fza_ah64_rocketweps2 || currentweapon _heli in fza_ah64_rocketweps3 || currentweapon _heli in fza_ah64_rocketweps4) then
			{
				//0.28777//
				fza_ah64_pylonelev = _curguncontrol;
				if("fza_ah64_rwp_fail" in (_heli magazinesturret [-1]) && "fza_ah64_lwp_fail" in (_heli magazinesturret [-1])) then {fza_ah64_pylonelev = 5.07;};
				if(_curguncontrol > 0) then {fza_ah64_pylonelev = _curguncontrol * 3;};
				if(_curguncontrol < 0) then {fza_ah64_pylonelev = _curguncontrol * 6;};
				if(fza_ah64_pylonelev > 1) then {fza_ah64_pylonelev = 1;};
				if(fza_ah64_pylonelev < -1) then {fza_ah64_pylonelev = -1;};
				...
				if("fza_auxtank_230_1" in magazines _heli) then {fza_ah64_pylonelev1 = 0.507;};
				if("fza_auxtank_230_2" in magazines _heli) then {fza_ah64_pylonelev2 = 0.507;};
				if("fza_auxtank_230_3" in magazines _heli) then {fza_ah64_pylonelev3 = 0.507;};
				if("fza_auxtank_230_4" in magazines _heli) then {fza_ah64_pylonelev4 = 0.507;};
