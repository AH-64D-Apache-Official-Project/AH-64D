...
fza_ah64_eachFrameArray  = [fza_mpd_fnc_update, fza_sfmplus_fnc_coreUpdate, fza_systems_fnc_coreUpdate, fza_laser_fnc_update, fza_hellfire_fnc_aceController, fza_ihadss_fnc_fovControl];
