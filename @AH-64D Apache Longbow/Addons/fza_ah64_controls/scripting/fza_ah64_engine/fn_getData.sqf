...
private ["_torque", "_ng", "_oil", "_tgt", "_torqueMul", "_npMul"];
...
switch (_object getVariable "fza_ah64_engineState") do {
	...
	case "OFFIDLE": {
		private _result = [_offIdleTransition, _object getVariable "fza_ah64_stateStartTime"] call fza_fnc_linearInterp;
	...
	case "IDLEOFF": {
		private _result = [_idleOffTransition, _object getVariable "fza_ah64_stateStartTime"] call fza_fnc_linearInterp;
		_npMul = _result select 1;
		_ng = _result select 2;
		_tgt = _result select 3;
		_oil = _result select 4;
	...
	case "IDLEFLY": {
		private _result = [_idleFlyTransition, _object getVariable "fza_ah64_stateStartTime"] call fza_fnc_linearInterp;
	...
	case "FLYIDLE": {
		private _result = [_flyIdleTransition, _object getVariable "fza_ah64_stateStartTime"] call fza_fnc_linearInterp;
		_ng = _result select 1;
		_tgt = _result select 2;
		_oil = _result select 3;
		_torqueMul = 100;
