...
COCKPIT_CONTROL("ctrlref_rmpd_m", "ctrlref_g_rmpd_m",rmpd, "Right MPD",menu, 0.015, "Right MPD Menu") COCKPIT_CONTROL_SEP
...
COCKPIT_CONTROL("ctrlref_lmpd_m", "ctrlref_g_lmpd_m",lmpd, "Left MPD",menu, 0.015, "Left MPD Menu") COCKPIT_CONTROL_SEP
