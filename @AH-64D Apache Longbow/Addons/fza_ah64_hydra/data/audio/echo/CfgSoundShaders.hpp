class CfgSoundShaders {
    ...
    {
        samples[] = {{"fza_ah64_controls\data\audio\Echo\Reflections\Small\houses.ogg", 1}};
        volume = "houses";
        range = 500;
        limitation = 1;
    ...
    {
        samples[] = {{"fza_ah64_controls\data\audio\Echo\Reflections\Small\meadow.ogg", 1}};
    ...
    {
        samples[] = {{"fza_ah64_controls\data\audio\Echo\Reflections\Small\forest.ogg", 1}};
        volume = "forest";
        range = 500;
        limitation = 1;
        rangeCurve[] = {{0, 1}, {100, 0.500000}, {500, 0}};
