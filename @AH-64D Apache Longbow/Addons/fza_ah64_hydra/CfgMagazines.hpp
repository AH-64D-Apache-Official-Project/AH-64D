class CfgMagazines {
    ...
    ROCKET_MAGAZINE_CONFIG(fza_275_m278, "M278 IR", "The M278 is an IR illumination warhead containing a parachute flare. It can illuminate an area of a square kilometer for approximately 100 seconds. It is mounted to a Mark 66 Mod 6 rocket motor with a trigger distance of 3.5km.");
};