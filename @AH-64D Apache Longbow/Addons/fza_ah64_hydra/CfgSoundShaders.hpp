class CfgSoundShaders {
    ...
    {
        samples[] = {{"fza_ah64_hydra\data\audio\echo\houses.ogg", 1}};
        volume = "houses";
        range = 500;
        limitation = 1;
    ...
    {
        samples[] = {{"fza_ah64_hydra\data\audio\echo\meadow.ogg", 1}};
    ...
    {
        samples[] = {{"fza_ah64_hydra\data\audio\echo\forest.ogg", 1}};
        volume = "forest";
        range = 500;
        limitation = 1;
        rangeCurve[] = {{0, 1}, {100, 0.500000}, {500, 0}};
    ...
    {
        samples[]  = {{"fza_ah64_hydra\data\audio\explosion\he.ogg", 1}};
        volume = 1;
        range = 150;
    ...
    {
        samples[] = {{"fza_ah64_hydra\data\audio\explosion\he_distance.ogg", 1}};
        volume = 1;
        range = 500;
