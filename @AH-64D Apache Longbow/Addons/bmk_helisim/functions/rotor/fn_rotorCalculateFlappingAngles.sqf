...
//SH79, eqn 32
private _a1_1 = 1.0 / (1.0 - _mu^2 / (2.0 * TIP_LOSS^2));
private _a1_2 = (2.0 * _lambda + (8.0 / 3.0) * (rad _theta75_deg)) * _mu;
private _a1_3 = if (_omega == 0) then { 0.0; } else { _p_w / _omega; };
private _a1_4 = if (_omega == 0) then { 0.0; } else { 16.0 * _q_w / (TIP_LOSS^4 * _gamma * _omega); };

private _a1_deg = _a1_1 * (_a1_2 + _a1_3 - _a1_4);
_a1_deg = deg _a1_deg;

//SH79, eqn 32
private _b1_1 = if (_mu == 0) then { 0.0; } else { 1 / (1.0 + _mu^2 / (2.0 * TIP_LOSS^2)); };
private _b1_2 = (4.0 / 3.0) * _mu * (rad _a0_deg);
private _b1_3 = if (_omega == 0) then { 0.0; } else { _q_w / _omega; };
private _b1_4 = if (_omega == 0) then { 0.0; } else { 16.0 * _q_w / (TIP_LOSS^4 * _gamma * _omega); };
