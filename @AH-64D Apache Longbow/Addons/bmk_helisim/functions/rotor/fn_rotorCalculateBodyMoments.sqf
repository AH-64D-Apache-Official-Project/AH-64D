...
private _a1s = (rad _a1_deg) * (cos _beta_deg) + (rad _b1_deg) * (sin _beta_deg) - (rad _BIC_deg);
private _b1s = (rad _b1_deg) * (cos _beta_deg) - (rad _a1_deg) * (sin _beta_deg) + (rad _AIC_deg);
