...
([_heli, _setRPM, _xmsnOutputRPM, 0.25, 1.00, _collectiveVal] call bmk_helisim_fnc_utilityGovernor)
    params ["_govInput"];
_govInput = [_govInput, -_refTq * 0.20, _refTq * 0.20] call BIS_fnc_clamp;
