...
if !_battBusOn exitwith {
    _heli setVariable ["fza_ah64_fireArmed1", [false, 0], true];
    _heli setVariable ["fza_ah64_fireArmed2", [false, 0], true];
    _heli setVariable ["fza_ah64_fireArmedApu", [false, 0], true];
    //FIRE Arm
...
_heli setObjectTexture ["in_lt_fireapurdy", ["", "\fza_ah64_us\tex\in\pushbut.paa"] select _engineApuArm];
//FIRE Detected
