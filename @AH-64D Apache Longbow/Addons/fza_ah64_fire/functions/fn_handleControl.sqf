...
switch(_control) do {
    ...
    case (localize "STR_FZA_AH64_FIRE_TEST_1"): {
    ...
    case (localize "STR_FZA_AH64_FIRE_TEST_2"): {
    ...
    case (localize "STR_FZA_AH64_FIRE_TEST_OFF"): {
    ...
    case "fireTestToggle": {
        ...
        if (_fireTest == 0) then {
            [_heli, _system, localize "STR_FZA_AH64_FIRE_TEST_1"] call fza_fnc_coreCockpitInteract;
            _heli animateSource [["cpg_firesw", "plt_firesw"] select (player == driver _heli), 1];
        };
        if (_fireTest == 1) then {
            [_heli, _system, localize "STR_FZA_AH64_FIRE_TEST_2"] call fza_fnc_coreCockpitInteract;
            _heli animateSource [["cpg_firesw", "plt_firesw"] select (player == driver _heli), 0]
        };
        if (_fireTest == 2) then {
            [_heli, _system, localize "STR_FZA_AH64_FIRE_TEST_OFF"] call fza_fnc_coreCockpitInteract;
