...
// Per-blade accumulated aerodynamic flap moments (N·m), one entry per virtual blade
...
_heli setVariable ["fza_sfmplus_rotorBeta0",       0.0]; // collective coning
_heli setVariable ["fza_sfmplus_rotorA1",          0.0]; // longitudinal disc tilt
_heli setVariable ["fza_sfmplus_rotorB1",          0.0]; // lateral disc tilt
// Pre-filter targets — smoothed over one rotor revolution before the main disc tilt filter
_heli setVariable ["fza_sfmplus_rotorBeta0Target", 0.0];
_heli setVariable ["fza_sfmplus_rotorA1Target",    0.0];
_heli setVariable ["fza_sfmplus_rotorB1Target",    0.0];
