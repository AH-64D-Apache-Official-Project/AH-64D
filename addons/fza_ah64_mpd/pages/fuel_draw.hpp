...
#define ANY_AUX_PRESENT C_OR(AUX_STN1_PRESENT, C_OR(AUX_STN2_PRESENT, C_OR(AUX_STN3_PRESENT, AUX_STN4_PRESENT)))
...
class AuxtanksDisplay {
    ...
    class AUX_GALLONS_BUTTON {
        condition = C_COND(C_AND(C_NOT(CHECK_ACTIVE), C_AND(C_NOT(C_MPD_USER(MFD_IND_FUEL_XFER_MENU)), ANY_AUX_PRESENT)));  // Hidden while CHECK is active or no aux tanks fitted; otherwise hide only in XFER menu
