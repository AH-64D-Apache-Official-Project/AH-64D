class VABs_Mode_Msl {
    ...
    class hide_mode {
        condition = C_COND(C_AND(C_EQ(C_MPD_USER(MFD_IND_WPN_POPOUT_MENU), 0), C_NOT(C_MPD_USER(MFD_IND_WPN_MSL_SELECTED_TYPE))));
        ...
        MPD_BOX_BAR_L(Mode, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_2_Y)
    };
};
...
class VABs_Mode_Msl_SAL {
    ...
    class NoChannelMenuPage {
        ...
        MPD_BOX_BAR_R(DEICE, MPD_POS_BUTTON_L_X, MPD_POS_BUTTON_LR_5_Y)
    };
    ...
    class Hide_type {
        condition = C_COND(C_AND(C_EQ(C_MPD_USER(MFD_IND_WPN_SELECTED_WPN), 3), C_EQ(C_MPD_USER(MFD_IND_WPN_POPOUT_MENU), 0)));
        ...
        class TrajBox_2 {
            condition = C_COND(C_NOT(C_EQ(C_MPD_USER(MFD_IND_WPN_POPOUT), 1)));
    ...
    MPD_BOX_BAR_T(DEICE, MPD_POS_BUTTON_TB_3_X, MPD_POS_BUTTON_T_Y)
    ...
    class TrajectorySelect {
        ...
        class Selected_traj_HI {
            condition = C_COND(C_EQ(C_MPD_USER(MFD_IND_WPN_POPOUT), 3));
...
class VABs_Mode_Msl_Rf {
    ...
    class TypeBarrierFcr {
        condition = C_COND(C_MPD_USER(MFD_IND_WPN_MSL_TYPE_BARRIER));
        MPD_BOX_BAR_L(TypeFcr, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_1_Y)
    };
};
