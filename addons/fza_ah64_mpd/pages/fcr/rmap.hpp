...
class root {
    ...
    // Masks overlap ~0.005 into the B-scope box (border lines redraw over the seam) because the
    // HTML canvas can never line up pixel-perfect with the HPP footprint — same approach as TPM.
    ...
    // TM 4.35.5: partial-intensity range lines and tics which correspond to each scan size.
    // 2/4/6 km lines span the selected sector; 1/3/5/7 km tics ride the selected sector
    // boundary lines; azimuth tics on the top border mark the smaller scan-size half-angles.
    // 0.090625 HPP/km, x = 0.5 +- (halfAngle/45)*0.32.
    class bscopeRangeLinesTics {
        class wideSel {
            ...
            class lines {
                ...
                points[] = {
                    ...
                    {{0.3400, 0.150}, 1}, {{0.3400, 0.165}, 1}, {},
                    {{0.3933, 0.150}, 1}, {{0.3933, 0.165}, 1}, {},
                    {{0.4467, 0.150}, 1}, {{0.4467, 0.165}, 1}, {},
                    {{0.5000, 0.150}, 1}, {{0.5000, 0.165}, 1}, {},
                    {{0.5533, 0.150}, 1}, {{0.5533, 0.165}, 1}, {},
                    {{0.6067, 0.150}, 1}, {{0.6067, 0.165}, 1}, {},
                    {{0.6600, 0.150}, 1}, {{0.6600, 0.165}, 1}, {},
                };
            };
        };
        class medSel {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.34, 0.694}, 1}, {{0.66, 0.694}, 1}, {},
                    {{0.34, 0.513}, 1}, {{0.66, 0.513}, 1}, {},
                    {{0.34, 0.331}, 1}, {{0.66, 0.331}, 1}, {},
                    {{0.34, 0.784}, 1}, {{0.37, 0.784}, 1}, {}, {{0.63, 0.784}, 1}, {{0.66, 0.784}, 1}, {},
                    {{0.34, 0.603}, 1}, {{0.37, 0.603}, 1}, {}, {{0.63, 0.603}, 1}, {{0.66, 0.603}, 1}, {},
                    {{0.34, 0.422}, 1}, {{0.37, 0.422}, 1}, {}, {{0.63, 0.422}, 1}, {{0.66, 0.422}, 1}, {},
                    {{0.34, 0.241}, 1}, {{0.37, 0.241}, 1}, {}, {{0.63, 0.241}, 1}, {{0.66, 0.241}, 1}, {},
                    {{0.3933, 0.150}, 1}, {{0.3933, 0.165}, 1}, {},
                    {{0.4467, 0.150}, 1}, {{0.4467, 0.165}, 1}, {},
                    {{0.5000, 0.150}, 1}, {{0.5000, 0.165}, 1}, {},
                    {{0.5533, 0.150}, 1}, {{0.5533, 0.165}, 1}, {},
        ...
        class nrwSel {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.3933, 0.694}, 1}, {{0.6067, 0.694}, 1}, {},
                    {{0.3933, 0.513}, 1}, {{0.6067, 0.513}, 1}, {},
                    {{0.3933, 0.331}, 1}, {{0.6067, 0.331}, 1}, {},
                    {{0.3933, 0.784}, 1}, {{0.4233, 0.784}, 1}, {}, {{0.5767, 0.784}, 1}, {{0.6067, 0.784}, 1}, {},
                    {{0.3933, 0.603}, 1}, {{0.4233, 0.603}, 1}, {}, {{0.5767, 0.603}, 1}, {{0.6067, 0.603}, 1}, {},
                    {{0.3933, 0.422}, 1}, {{0.4233, 0.422}, 1}, {}, {{0.5767, 0.422}, 1}, {{0.6067, 0.422}, 1}, {},
                    {{0.3933, 0.241}, 1}, {{0.4233, 0.241}, 1}, {}, {{0.5767, 0.241}, 1}, {{0.6067, 0.241}, 1}, {},
                    {{0.4467, 0.150}, 1}, {{0.4467, 0.165}, 1}, {},
                    {{0.5000, 0.150}, 1}, {{0.5000, 0.165}, 1}, {},
                    {{0.5533, 0.150}, 1}, {{0.5533, 0.165}, 1}, {},
                };
        ...
        class zoomSel {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.4467, 0.694}, 1}, {{0.5533, 0.694}, 1}, {},
                    {{0.4467, 0.513}, 1}, {{0.5533, 0.513}, 1}, {},
                    {{0.4467, 0.331}, 1}, {{0.5533, 0.331}, 1}, {},
                    {{0.4467, 0.784}, 1}, {{0.4667, 0.784}, 1}, {}, {{0.5333, 0.784}, 1}, {{0.5533, 0.784}, 1}, {},
                    {{0.4467, 0.603}, 1}, {{0.4667, 0.603}, 1}, {}, {{0.5333, 0.603}, 1}, {{0.5533, 0.603}, 1}, {},
                    {{0.4467, 0.422}, 1}, {{0.4667, 0.422}, 1}, {}, {{0.5333, 0.422}, 1}, {{0.5533, 0.422}, 1}, {},
                    {{0.4467, 0.241}, 1}, {{0.4667, 0.241}, 1}, {}, {{0.5333, 0.241}, 1}, {{0.5533, 0.241}, 1}, {},
                    {{0.5000, 0.150}, 1}, {{0.5000, 0.165}, 1}, {},
                };
            };
        };
    ...
    // TM fig 4-35 (LBA2590A): fixed +-45 axis — sector boundary verticals per size,
    // selected full intensity, larger sizes dim (MFD ignores color alpha, so dim RGB)
    class sectorBoundaries {
        class medFull {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.3400, 0.150}, 1}, {{0.3400, 0.875}, 1}, {},
                    {{0.6600, 0.150}, 1}, {{0.6600, 0.875}, 1}, {},
                };
            };
        };
        class medPartial {
        ...
        class nrwFull {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.3933, 0.150}, 1}, {{0.3933, 0.875}, 1}, {},
                    {{0.6067, 0.150}, 1}, {{0.6067, 0.875}, 1}, {},
                };
            };
        };
        class nrwPartial {
        ...
        class zoomFull {
            ...
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.4467, 0.150}, 1}, {{0.4467, 0.875}, 1}, {},
                    {{0.5533, 0.150}, 1}, {{0.5533, 0.875}, 1}, {},
                };
            };
        };
    };

    // TM 4.35.5b5: single RFI tic on each outer boundary of the wide sector symbol (6.75 km)
    class rfiTics {
        class wideFull {
            condition = C_COND(C_EQ(C_MPD_USER(MFD_IND_FCR_SCAN_SIZE), 0));
            class lines {
                ...
                width = 2;
                points[] = {
                    {{0.180, 0.2633}, 1}, {{0.150, 0.2633}, 1}, {},
                    {{0.820, 0.2633}, 1}, {{0.850, 0.2633}, 1}, {},
                };
            };
        };
        class widePartial {
