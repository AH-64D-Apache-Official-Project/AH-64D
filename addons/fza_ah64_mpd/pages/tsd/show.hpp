...
class tsdShow {
    ...
    //R1
    class CTRLMBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_CTRLM));
    ...
    //R2
    class ENEMYUNITBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_ENEMY_UNITS));
    ...
    class FRIENDLYUNITBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_FRIENDLY_UNITS));
    ...
    //R4
    MPD_BOX_BAR_L(RFI, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_4_Y)
    MPD_TEXT_L(RFI, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_4_Y, MPD_TEXT_STATIC("RFI THREATS"))
    //R5
    class RLWRBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_RLWR));
...
class AtkOnly {
    ...
    //R6
    MPD_BOX_BAR_L(OBST, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_6_Y)
    MPD_TEXT_L(OBST, MPD_POS_BUTTON_R_X, MPD_POS_BUTTON_LR_6_Y, MPD_TEXT_STATIC("TOTAL TARGETS/OBSTACLES"))

    //B4
    class SHOTBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_SHOT));
    ...
    //B6
    class HAZBox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_HAZ));
    ...
    //L4
    class WPTDATABox {
        condition = C_COND(C_MPD_USER(MFD_IND_TSD_SHOW_WPT_DATA_CURRTE));
