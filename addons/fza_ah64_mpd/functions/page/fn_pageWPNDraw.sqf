...
_heli setUserMFDValue [MFD_INDEX_OFFSET(MFD_IND_WPN_PYLON_1_4_FAILURE), (BOOLTONUM(1 in _pylonFailure))+([0, 2] select (4 in _pylonFailure))];
_heli setUserMFDValue [MFD_INDEX_OFFSET(MFD_IND_WPN_PYLON_2_3_FAILURE), (BOOLTONUM(2 in _pylonFailure))+([0, 2] select (3 in _pylonFailure))];
...
_heli setUserMFDValue [MFD_INDEX_OFFSET(MFD_IND_WPN_ROCKET_POD_1_4_STATE), (BOOLTONUM(0 in _pylonsWithRockets))+([0, 2] select (12 in _pylonsWithRockets))];
_heli setUserMFDValue [MFD_INDEX_OFFSET(MFD_IND_WPN_ROCKET_POD_2_3_STATE), (BOOLTONUM(4 in _pylonsWithRockets))+([0, 2] select (8 in _pylonsWithRockets))];
