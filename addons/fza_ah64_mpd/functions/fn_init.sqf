...
_heli setObjectTexture ["cpg_cl_mpd_back", "#(rgb,2048,2048,1)ui(RscFzaAH64MPD,left)"];
_heli setObjectTexture ["cpg_cr_mpd_back", "#(rgb,2048,2048,1)ui(RscFzaAH64MPD,right)"];
