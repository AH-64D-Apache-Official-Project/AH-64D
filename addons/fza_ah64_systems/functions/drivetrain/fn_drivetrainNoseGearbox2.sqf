...
private _engPctTq         = _heli getVariable "fza_sfmplus_engPctTQ" select 1;
...
private _randomTq         = _heli getVariable "fza_sfmplus_randomTq" select 1;
...
[_heli, "fza_sfmplus_randomTq", 1, _randomTq, true] call fza_fnc_setArrayVariable;

if (_grbxHitPtDmg == 1.0) then {
    _engOverspeed = true;
    [_heli, "fza_ah64_engineOverspeed", 1, _engOverspeed, false] call fza_fnc_setArrayVariable;
};
