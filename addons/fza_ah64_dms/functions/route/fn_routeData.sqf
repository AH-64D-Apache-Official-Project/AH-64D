...
private _currentPnt  = if (_rteCycleList isNotEqualTo [] && _rteCycleIndex > -1) then {_rteCycleList#_rteCycleIndex;} else {-1;};
...
private _angle = [_angle, 90] select ((_course1 == -1) || (_course2 == -1));
