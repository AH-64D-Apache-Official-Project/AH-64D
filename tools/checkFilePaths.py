...
reValidFolderName = re.compile(r'^[a-z][a-zA-Z0-9]*(_[a-z][a-zA-Z0-9]*)*$')
reValidFileName = re.compile(r'^[a-z][a-zA-Z0-9]*(_[a-z][a-zA-Z0-9]*)*\.[a-z]+$')
reValidConfigName = re.compile(r'(Cfg|Fza)[A-Z][a-z0-9A-Z]*\.hpp')
