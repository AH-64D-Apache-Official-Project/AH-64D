...
{
if(fuel _heli > 0) then {_basefuel = fuel _heli;};
if(!(player == driver _heli || player == gunner _heli)) then {_heli setfuel _basefuel;};
waituntil {(player == driver _heli || player == gunner _heli)};
if(isNil "fza_ah64_fuelsave") then {fza_ah64_fuelsave = fuel _heli;};
_mags = magazines _heli;
_curfuel = fuel _heli;
if(_curfuel > 0 && !(isengineon _heli)) then {fza_ah64_fuelsave = fuel _heli;};
if(isengineon _heli && player in _heli) then {fza_ah64_fuelsave = fuel _heli; _fueltrigger = false;};
if(player == driver _heli) then
{
if("fza_ah64_fwd_leak" in (_heli magazinesturret [-1]) || "fza_ah64_aft_leak" in (_heli magazinesturret [-1])) then {fza_ah64_fuelsave = fza_ah64_fuelsave - 0.0003;};
if(fza_ah64_cem && fuel _heli > 0 && !(fza_ah64_estarted) && !(_fueltrigger)) then {_heli setfuel 0; _fueltrigger = true;};
if(fza_ah64_cem && !(isengineon _heli) && !(fza_ah64_estarted)) then {_heli setfuel 0;};
if(fza_ah64_cem && fza_ah64_estarted && _fueltrigger) then {_heli setfuel fza_ah64_fuelsave; fza_ah64_fuelsave = fuel _heli; _fueltrigger = false;};
};
if(local _heli && isengineon _heli) then
{
_fuelused = 1 - fza_ah64_fuelsave;
if("fza_iafs_130" in _mags && _iafs130qty > 0) then {_activetank = 5;};
if("fza_iafs_100" in _mags && _iafs100qty > 0) then {_activetank = 4;};
if("fza_auxtank_230_4" in _mags && _waux230qty_4 > 0) then {_activetank = 3;};
if("fza_auxtank_230_1" in _mags && _waux230qty_1 > 0) then {_activetank = 0;};
if("fza_auxtank_230_2" in _mags && _waux230qty_2 > 0) then {_activetank = 1;};
if("fza_auxtank_230_3" in _mags && _waux230qty_3 > 0) then {_activetank = 2;};
///////////////WINGAUX//////////////////
...
_burnrate = 0.1875;
if(_heli animationphase "plt_eng1_start" > 0) then {fza_ah64_fuelsave = fza_ah64_fuelsave - 0.000002; _burnrate = _burnrate + 0.1875;};
if(_heli animationphase "plt_eng2_start" > 0) then {fza_ah64_fuelsave = fza_ah64_fuelsave - 0.000002; _burnrate = _burnrate + 0.1875;};
};
...
if("fza_iafs_130" in _mags) then {_iafsfuel = round(_iafs130qty * 2506);};
...
//0.00015
if(isengineon _heli) then {_burnrate = 1;};
_leburnrate = round (_burnrate * 480);
_reburnrate = round (_burnrate * 480);
_totburnrate = round (_burnrate * 960);
if(_leburnrate > 999) then {_leburnrate = 999;};
if(_reburnrate > 999) then {_reburnrate = 999;};
if(_totburnrate > 999) then {_totburnrate = 999;};
...
if("fza_auxtank_230_1" in _mags) then
{
	if(_waux230qty_1 > 0) then {_curwaux1 = "\fza_ah64_us\tex\Ftank_ca.paa";};
	if(_waux230qty_1 <= 0) then {_curwaux1 = "\fza_ah64_us\tex\Etank_ca.paa";};
...
if("fza_auxtank_230_2" in _mags) then
{
	if(_waux230qty_2 > 0) then {_curwaux2 = "\fza_ah64_us\tex\Ftank_ca.paa";};
	if(_waux230qty_2 <= 0) then {_curwaux2 = "\fza_ah64_us\tex\Etank_ca.paa";};
...
if("fza_auxtank_230_3" in _mags) then
{
	if(_waux230qty_3 > 0) then {_curwaux3 = "\fza_ah64_us\tex\Ftank_ca.paa";};
	if(_waux230qty_3 <= 0) then {_curwaux3 = "\fza_ah64_us\tex\Etank_ca.paa";};
...
if("fza_auxtank_230_4" in _mags) then
{
	if(_waux230qty_4 > 0) then {_curwaux4 = "\fza_ah64_us\tex\Ftank_ca.paa";};
	if(_waux230qty_4 <= 0) then {_curwaux4 = "\fza_ah64_us\tex\Etank_ca.paa";};
