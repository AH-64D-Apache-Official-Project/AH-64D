...
if(!(isNil "fza_ah64_waypointfin") and fza_ah64_waypointfin == 0) exitwith {_heli vehiclechat "Waypoint configuration already active.";};
...
waituntil{(fza_ah64_waypointfin == 1 || !(alive _heli))};
