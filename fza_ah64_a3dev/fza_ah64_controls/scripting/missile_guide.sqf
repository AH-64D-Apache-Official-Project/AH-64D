...
fza_ah64_misguidearray = fza_ah64_misguidearray + [[_bomb,_target,_launchmode,_designator,_curarrayidx,_posdetector,_jetalt,_basetargdist]];
...
if(!(isNull _inittarg)) then {deletevehicle _inittarg;};